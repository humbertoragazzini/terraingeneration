...
2. Select the repository, in this case :[Git Hub Repository](https://github.com/humbertoragazzini/terraingeneration).
...
2.  2.a) First of all we need to install git from this link [GitBash](https://git-scm.com/downloads) .
    ...
    `git clone https://github.com/humbertoragazzini/terraingeneration.git `
