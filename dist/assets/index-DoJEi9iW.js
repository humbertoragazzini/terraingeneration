...
`)}function C_(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),e[o]={type:s.type,location:i.getAttribLocation(t,o),locationSize:a}}return e}function Gr(i){return i!==""}function Dc(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Uc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const R_=/^[ \t]*#include +<([\w\d./]+)>/gm;function ll(i){return i.replace(R_,L_)}const P_=new Map;function L_(i,t){let e=Gt[t];if(e===void 0){const n=P_.get(t);if(n!==void 0)e=Gt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ll(e)}const I_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Nc(i){return i.replace(I_,D_)}function D_(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Fc(i){let t=`precision ${i.precision} float;
...
`].filter(Gr).join(`
`)),o=ll(o),o=Dc(o,e),o=Uc(o,e),a=ll(a),a=Dc(a,e),a=Uc(a,e),o=Nc(o),a=Nc(a),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
}`;function W0(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let Kc=!1;class Dl{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:r,title:s="Controls",closeFolders:o=!1,injectStyles:a=!0,touchStyles:l=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(s),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!Kc&&a&&(W0(G0),Kc=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),r&&this.domElement.style.setProperty("--width",r+"px"),this._closeFolders=o}add(t,e,n,r,s){if(Object(n)===n)return new H0(this,t,e,n);const o=t[e];switch(typeof o){case"number":return new k0(this,t,e,n,r,s);case"boolean":return new D0(this,t,e);case"string":return new V0(this,t,e);case"function":return new ra(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,o)}addColor(t,e,n=1){return new z0(this,t,e,n)}addFolder(t){const e=new Dl({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof ra||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof ra)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=s=>{s.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const r=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=r+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const Eh=0,X0=1,Y0=2,Zc=2,sa=1.25,Jc=1,$r=6*4+4+4,So=65535,$0=Math.pow(2,-24),oa=Symbol("SKIP_GENERATION");function j0(i){return i.index?i.index.count:i.attributes.position.count}function Tr(i){return j0(i)/3}function q0(i,t=ArrayBuffer){return i>65535?new Uint32Array(new t(4*i)):new Uint16Array(new t(2*i))}function K0(i,t){if(!i.index){const e=i.attributes.position.count,n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,r=q0(e,n);i.setIndex(new Be(r,1));for(let s=0;s<e;s++)r[s]=s}}function bh(i,t){const e=Tr(i),n=t||i.drawRange,r=n.start/3,s=(n.start+n.count)/3,o=Math.max(0,r),a=Math.min(e,s)-o;return[{offset:Math.floor(o),count:Math.floor(a)}]}function Ah(i,t){if(!i.groups||!i.groups.length)return bh(i,t);const e=[],n=new Set,r=t||i.drawRange,s=r.start/3,o=(r.start+r.count)/3;for(const l of i.groups){const c=l.start/3,u=(l.start+l.count)/3;n.add(Math.max(s,c)),n.add(Math.min(o,u))}const a=Array.from(n.values()).sort((l,c)=>l-c);for(let l=0;l<a.length-1;l++){const c=a[l],u=a[l+1];e.push({offset:Math.floor(c),count:Math.floor(u-c)})}return e}function Z0(i,t){const e=Tr(i),n=Ah(i,t).sort((o,a)=>o.offset-a.offset),r=n[n.length-1];r.count=Math.min(e-r.offset,r.count);let s=0;return n.forEach(({count:o})=>s+=o),e!==s}function aa(i,t,e,n,r){let s=1/0,o=1/0,a=1/0,l=-1/0,c=-1/0,u=-1/0,d=1/0,f=1/0,m=1/0,v=-1/0,S=-1/0,p=-1/0;for(let h=t*6,M=(t+e)*6;h<M;h+=6){const y=i[h+0],E=i[h+1],C=y-E,A=y+E;C<s&&(s=C),A>l&&(l=A),y<d&&(d=y),y>v&&(v=y);const b=i[h+2],x=i[h+3],_=b-x,g=b+x;_<o&&(o=_),g>c&&(c=g),b<f&&(f=b),b>S&&(S=b);const w=i[h+4],P=i[h+5],U=w-P,F=w+P;U<a&&(a=U),F>u&&(u=F),w<m&&(m=w),w>p&&(p=w)}n[0]=s,n[1]=o,n[2]=a,n[3]=l,n[4]=c,n[5]=u,r[0]=d,r[1]=f,r[2]=m,r[3]=v,r[4]=S,r[5]=p}function J0(i,t=null,e=null,n=null){const r=i.attributes.position,s=i.index?i.index.array:null,o=Tr(i),a=r.normalized;let l;t===null?(l=new Float32Array(o*6),e=0,n=o):(l=t,e=e||0,n=n||o);const c=r.array,u=r.offset||0;let d=3;r.isInterleavedBufferAttribute&&(d=r.data.stride);const f=["getX","getY","getZ"];for(let m=e;m<e+n;m++){const v=m*3,S=m*6;let p=v+0,h=v+1,M=v+2;s&&(p=s[p],h=s[h],M=s[M]),a||(p=p*d+u,h=h*d+u,M=M*d+u);for(let y=0;y<3;y++){let E,C,A;a?(E=r[f[y]](p),C=r[f[y]](h),A=r[f[y]](M)):(E=c[p+y],C=c[h+y],A=c[M+y]);let b=E;C<b&&(b=C),A<b&&(b=A);let x=E;C>x&&(x=C),A>x&&(x=A);const _=(x-b)/2,g=y*2;l[S+g+0]=b+_,l[S+g+1]=_+(Math.abs(b)+_)*$0}}return l}function ae(i,t,e){return e.min.x=t[i],e.min.y=t[i+1],e.min.z=t[i+2],e.max.x=t[i+3],e.max.y=t[i+4],e.max.z=t[i+5],e}function Qc(i){let t=-1,e=-1/0;for(let n=0;n<3;n++){const r=i[n+3]-i[n];r>e&&(e=r,t=n)}return t}function tu(i,t){t.set(i)}function eu(i,t,e){let n,r;for(let s=0;s<3;s++){const o=s+3;n=i[s],r=t[s],e[s]=n<r?n:r,n=i[o],r=t[o],e[o]=n>r?n:r}}function Cs(i,t,e){for(let n=0;n<3;n++){const r=t[i+2*n],s=t[i+2*n+1],o=r-s,a=r+s;o<e[n]&&(e[n]=o),a>e[n+3]&&(e[n+3]=a)}}function Dr(i){const t=i[3]-i[0],e=i[4]-i[1],n=i[5]-i[2];return 2*(t*e+e*n+n*t)}const Un=32,Q0=(i,t)=>i.candidate-t.candidate,Jn=new Array(Un).fill().map(()=>({count:0,bounds:new Float32Array(6),rightCacheBounds:new Float32Array(6),leftCacheBounds:new Float32Array(6),candidate:0})),Rs=new Float32Array(6);function tv(i,t,e,n,r,s){let o=-1,a=0;if(s===Eh)o=Qc(t),o!==-1&&(a=(t[o]+t[o+3])/2);else if(s===X0)o=Qc(i),o!==-1&&(a=ev(e,n,r,o));else if(s===Y0){const l=Dr(i);let c=sa*r;const u=n*6,d=(n+r)*6;for(let f=0;f<3;f++){const m=t[f],p=(t[f+3]-m)/Un;if(r<Un/4){const h=[...Jn];h.length=r;let M=0;for(let E=u;E<d;E+=6,M++){const C=h[M];C.candidate=e[E+2*f],C.count=0;const{bounds:A,leftCacheBounds:b,rightCacheBounds:x}=C;for(let _=0;_<3;_++)x[_]=1/0,x[_+3]=-1/0,b[_]=1/0,b[_+3]=-1/0,A[_]=1/0,A[_+3]=-1/0;Cs(E,e,A)}h.sort(Q0);let y=r;for(let E=0;E<y;E++){const C=h[E];for(;E+1<y&&h[E+1].candidate===C.candidate;)h.splice(E+1,1),y--}for(let E=u;E<d;E+=6){const C=e[E+2*f];for(let A=0;A<y;A++){const b=h[A];C>=b.candidate?Cs(E,e,b.rightCacheBounds):(Cs(E,e,b.leftCacheBounds),b.count++)}}for(let E=0;E<y;E++){const C=h[E],A=C.count,b=r-C.count,x=C.leftCacheBounds,_=C.rightCacheBounds;let g=0;A!==0&&(g=Dr(x)/l);let w=0;b!==0&&(w=Dr(_)/l);const P=Jc+sa*(g*A+w*b);P<c&&(o=f,c=P,a=C.candidate)}}else{for(let y=0;y<Un;y++){const E=Jn[y];E.count=0,E.candidate=m+p+y*p;const C=E.bounds;for(let A=0;A<3;A++)C[A]=1/0,C[A+3]=-1/0}for(let y=u;y<d;y+=6){let A=~~((e[y+2*f]-m)/p);A>=Un&&(A=Un-1);const b=Jn[A];b.count++,Cs(y,e,b.bounds)}const h=Jn[Un-1];tu(h.bounds,h.rightCacheBounds);for(let y=Un-2;y>=0;y--){const E=Jn[y],C=Jn[y+1];eu(E.bounds,C.rightCacheBounds,E.rightCacheBounds)}let M=0;for(let y=0;y<Un-1;y++){const E=Jn[y],C=E.count,A=E.bounds,x=Jn[y+1].rightCacheBounds;C!==0&&(M===0?tu(A,Rs):eu(A,Rs,Rs)),M+=C;let _=0,g=0;M!==0&&(_=Dr(Rs)/l);const w=r-M;w!==0&&(g=Dr(x)/l);const P=Jc+sa*(_*M+g*w);P<c&&(o=f,c=P,a=E.candidate)}}}}else console.warn(`MeshBVH: Invalid build strategy value ${s} used.`);return{axis:o,pos:a}}function ev(i,t,e,n){let r=0;for(let s=t,o=t+e;s<o;s++)r+=i[s*6+n*2];return r/e}class la{constructor(){this.boundingData=new Float32Array(6)}}function nv(i,t,e,n,r,s){let o=n,a=n+r-1;const l=s.pos,c=s.axis*2;for(;;){for(;o<=a&&e[o*6+c]<l;)o++;for(;o<=a&&e[a*6+c]>=l;)a--;if(o<a){for(let u=0;u<3;u++){let d=t[o*3+u];t[o*3+u]=t[a*3+u],t[a*3+u]=d}for(let u=0;u<6;u++){let d=e[o*6+u];e[o*6+u]=e[a*6+u],e[a*6+u]=d}o++,a--}else return o}}function iv(i,t,e,n,r,s){let o=n,a=n+r-1;const l=s.pos,c=s.axis*2;for(;;){for(;o<=a&&e[o*6+c]<l;)o++;for(;o<=a&&e[a*6+c]>=l;)a--;if(o<a){let u=i[o];i[o]=i[a],i[a]=u;for(let d=0;d<6;d++){let f=e[o*6+d];e[o*6+d]=e[a*6+d],e[a*6+d]=f}o++,a--}else return o}}function Fe(i,t){return t[i+15]===65535}function Xe(i,t){return t[i+6]}function tn(i,t){return t[i+14]}function en(i){return i+8}function nn(i,t){return t[i+6]}function wh(i,t){return t[i+7]}let Th,Wr,to,Ch;const rv=Math.pow(2,32);function ul(i){return"count"in i?1:1+ul(i.left)+ul(i.right)}function sv(i,t,e){return Th=new Float32Array(e),Wr=new Uint32Array(e),to=new Uint16Array(e),Ch=new Uint8Array(e),hl(i,t)}function hl(i,t){const e=i/4,n=i/2,r="count"in t,s=t.boundingData;for(let o=0;o<6;o++)Th[e+o]=s[o];if(r)if(t.buffer){const o=t.buffer;Ch.set(new Uint8Array(o),i);for(let a=i,l=i+o.byteLength;a<l;a+=$r){const c=a/2;Fe(c,to)||(Wr[a/4+6]+=e)}return i+o.byteLength}else{const o=t.offset,a=t.count;return Wr[e+6]=o,to[n+14]=a,to[n+15]=So,i+$r}else{const o=t.left,a=t.right,l=t.splitAxis;let c;if(c=hl(i+$r,o),c/4>rv)throw new Error("MeshBVH: Cannot store child pointer greater than 32 bits.");return Wr[e+6]=c/4,c=hl(c,a),Wr[e+7]=l,c}}function ov(i,t){const e=(i.index?i.index.count:i.attributes.position.count)/3,n=e>2**16,r=n?4:2,s=t?new SharedArrayBuffer(e*r):new ArrayBuffer(e*r),o=n?new Uint32Array(s):new Uint16Array(s);for(let a=0,l=o.length;a<l;a++)o[a]=a;return o}function av(i,t,e,n,r){const{maxDepth:s,verbose:o,maxLeafTris:a,strategy:l,onProgress:c,indirect:u}=r,d=i._indirectBuffer,f=i.geometry,m=f.index?f.index.array:null,v=u?iv:nv,S=Tr(f),p=new Float32Array(6);let h=!1;const M=new la;return aa(t,e,n,M.boundingData,p),E(M,e,n,p),M;function y(C){c&&c(C/S)}function E(C,A,b,x=null,_=0){if(!h&&_>=s&&(h=!0,o&&(console.warn(`MeshBVH: Max depth of ${s} reached when generating BVH. Consider increasing maxDepth.`),console.warn(f))),b<=a||_>=s)return y(A+b),C.offset=A,C.count=b,C;const g=tv(C.boundingData,x,t,A,b,l);if(g.axis===-1)return y(A+b),C.offset=A,C.count=b,C;const w=v(d,m,t,A,b,g);if(w===A||w===A+b)y(A+b),C.offset=A,C.count=b;else{C.splitAxis=g.axis;const P=new la,U=A,F=w-A;C.left=P,aa(t,U,F,P.boundingData,p),E(P,U,F,p,_+1);const k=new la,B=w,V=b-F;C.right=k,aa(t,B,V,k.boundingData,p),E(k,B,V,p,_+1)}return C}}function lv(i,t){const e=i.geometry;t.indirect&&(i._indirectBuffer=ov(e,t.useSharedArrayBuffer),Z0(e,t.range)&&!t.verbose&&console.warn('MeshBVH: Provided geometry contains groups or a range that do not fully span the vertex contents while using the "indirect" option. BVH may incorrectly report intersections on unrendered portions of the geometry.')),i._indirectBuffer||K0(e,t);const n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,r=J0(e),s=t.indirect?bh(e,t.range):Ah(e,t.range);i._roots=s.map(o=>{const a=av(i,r,o.offset,o.count,t),l=ul(a),c=new n($r*l);return sv(0,a,c),c})}class Hn{constructor(){this.min=1/0,this.max=-1/0}setFromPointsField(t,e){let n=1/0,r=-1/0;for(let s=0,o=t.length;s<o;s++){const l=t[s][e];n=l<n?l:n,r=l>r?l:r}this.min=n,this.max=r}setFromPoints(t,e){let n=1/0,r=-1/0;for(let s=0,o=e.length;s<o;s++){const a=e[s],l=t.dot(a);n=l<n?l:n,r=l>r?l:r}this.min=n,this.max=r}isSeparated(t){return this.min>t.max||t.min>this.max}}Hn.prototype.setFromBox=function(){const i=new z;return function(e,n){const r=n.min,s=n.max;let o=1/0,a=-1/0;for(let l=0;l<=1;l++)for(let c=0;c<=1;c++)for(let u=0;u<=1;u++){i.x=r.x*l+s.x*(1-l),i.y=r.y*c+s.y*(1-c),i.z=r.z*u+s.z*(1-u);const d=e.dot(i);o=Math.min(d,o),a=Math.max(d,a)}this.min=o,this.max=a}}();const cv=function(){const i=new z,t=new z,e=new z;return function(r,s,o){const a=r.start,l=i,c=s.start,u=t;e.subVectors(a,c),i.subVectors(r.end,r.start),t.subVectors(s.end,s.start);const d=e.dot(u),f=u.dot(l),m=u.dot(u),v=e.dot(l),p=l.dot(l)*m-f*f;let h,M;p!==0?h=(d*f-v*m)/p:h=0,M=(d+h*f)/m,o.x=h,o.y=M}}(),Ul=function(){const i=new Rt,t=new z,e=new z;return function(r,s,o,a){cv(r,s,i);let l=i.x,c=i.y;if(l>=0&&l<=1&&c>=0&&c<=1){r.at(l,o),s.at(c,a);return}else if(l>=0&&l<=1){c<0?s.at(0,a):s.at(1,a),r.closestPointToPoint(a,!0,o);return}else if(c>=0&&c<=1){l<0?r.at(0,o):r.at(1,o),s.closestPointToPoint(o,!0,a);return}else{let u;l<0?u=r.start:u=r.end;let d;c<0?d=s.start:d=s.end;const f=t,m=e;if(r.closestPointToPoint(d,!0,t),s.closestPointToPoint(u,!0,e),f.distanceToSquared(d)<=m.distanceToSquared(u)){o.copy(f),a.copy(d);return}else{o.copy(u),a.copy(m);return}}}}(),uv=function(){const i=new z,t=new z,e=new dn,n=new sn;return function(s,o){const{radius:a,center:l}=s,{a:c,b:u,c:d}=o;if(n.start=c,n.end=u,n.closestPointToPoint(l,!0,i).distanceTo(l)<=a||(n.start=c,n.end=d,n.closestPointToPoint(l,!0,i).distanceTo(l)<=a)||(n.start=u,n.end=d,n.closestPointToPoint(l,!0,i).distanceTo(l)<=a))return!0;const S=o.getPlane(e);if(Math.abs(S.distanceToPoint(l))<=a){const h=S.projectPoint(l,t);if(o.containsPoint(h))return!0}return!1}}(),hv=1e-15;function ca(i){return Math.abs(i)<hv}class on extends re{constructor(...t){super(...t),this.isExtendedTriangle=!0,this.satAxes=new Array(4).fill().map(()=>new z),this.satBounds=new Array(4).fill().map(()=>new Hn),this.points=[this.a,this.b,this.c],this.sphere=new xo,this.plane=new dn,this.needsUpdate=!0}intersectsSphere(t){return uv(t,this)}update(){const t=this.a,e=this.b,n=this.c,r=this.points,s=this.satAxes,o=this.satBounds,a=s[0],l=o[0];this.getNormal(a),l.setFromPoints(a,r);const c=s[1],u=o[1];c.subVectors(t,e),u.setFromPoints(c,r);const d=s[2],f=o[2];d.subVectors(e,n),f.setFromPoints(d,r);const m=s[3],v=o[3];m.subVectors(n,t),v.setFromPoints(m,r),this.sphere.setFromPoints(this.points),this.plane.setFromNormalAndCoplanarPoint(a,t),this.needsUpdate=!1}}on.prototype.closestPointToSegment=function(){const i=new z,t=new z,e=new sn;return function(r,s=null,o=null){const{start:a,end:l}=r,c=this.points;let u,d=1/0;for(let f=0;f<3;f++){const m=(f+1)%3;e.start.copy(c[f]),e.end.copy(c[m]),Ul(e,r,i,t),u=i.distanceToSquared(t),u<d&&(d=u,s&&s.copy(i),o&&o.copy(t))}return this.closestPointToPoint(a,i),u=a.distanceToSquared(i),u<d&&(d=u,s&&s.copy(i),o&&o.copy(a)),this.closestPointToPoint(l,i),u=l.distanceToSquared(i),u<d&&(d=u,s&&s.copy(i),o&&o.copy(l)),Math.sqrt(d)}}();on.prototype.intersectsTriangle=function(){const i=new on,t=new Array(3),e=new Array(3),n=new Hn,r=new Hn,s=new z,o=new z,a=new z,l=new z,c=new z,u=new sn,d=new sn,f=new sn,m=new z;function v(S,p,h){const M=S.points;let y=0,E=-1;for(let C=0;C<3;C++){const{start:A,end:b}=u;A.copy(M[C]),b.copy(M[(C+1)%3]),u.delta(o);const x=ca(p.distanceToPoint(A));if(ca(p.normal.dot(o))&&x){h.copy(u),y=2;break}const _=p.intersectLine(u,m);if(!_&&x&&m.copy(A),(_||x)&&!ca(m.distanceTo(b))){if(y<=1)(y===1?h.start:h.end).copy(m),x&&(E=y);else if(y>=2){(E===1?h.start:h.end).copy(m),y=2;break}if(y++,y===2&&E===-1)break}}return y}return function(p,h=null,M=!1){this.needsUpdate&&this.update(),p.isExtendedTriangle?p.needsUpdate&&p.update():(i.copy(p),i.update(),p=i);const y=this.plane,E=p.plane;if(Math.abs(y.normal.dot(E.normal))>1-1e-10){const C=this.satBounds,A=this.satAxes;e[0]=p.a,e[1]=p.b,e[2]=p.c;for(let _=0;_<4;_++){const g=C[_],w=A[_];if(n.setFromPoints(w,e),g.isSeparated(n))return!1}const b=p.satBounds,x=p.satAxes;t[0]=this.a,t[1]=this.b,t[2]=this.c;for(let _=0;_<4;_++){const g=b[_],w=x[_];if(n.setFromPoints(w,t),g.isSeparated(n))return!1}for(let _=0;_<4;_++){const g=A[_];for(let w=0;w<4;w++){const P=x[w];if(s.crossVectors(g,P),n.setFromPoints(s,t),r.setFromPoints(s,e),n.isSeparated(r))return!1}}return h&&(M||console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."),h.start.set(0,0,0),h.end.set(0,0,0)),!0}else{const C=v(this,E,d);if(C===1&&p.containsPoint(d.end))return h&&(h.start.copy(d.end),h.end.copy(d.end)),!0;if(C!==2)return!1;const A=v(p,y,f);if(A===1&&this.containsPoint(f.end))return h&&(h.start.copy(f.end),h.end.copy(f.end)),!0;if(A!==2)return!1;if(d.delta(a),f.delta(l),a.dot(l)<0){let U=f.start;f.start=f.end,f.end=U}const b=d.start.dot(a),x=d.end.dot(a),_=f.start.dot(a),g=f.end.dot(a),w=x<_,P=b<g;return b!==g&&_!==x&&w===P?!1:(h&&(c.subVectors(d.start,f.start),c.dot(a)>0?h.start.copy(d.start):h.start.copy(f.start),c.subVectors(d.end,f.end),c.dot(a)<0?h.end.copy(d.end):h.end.copy(f.end)),!0)}}}();on.prototype.distanceToPoint=function(){const i=new z;return function(e){return this.closestPointToPoint(e,i),e.distanceTo(i)}}();on.prototype.distanceToTriangle=function(){const i=new z,t=new z,e=["a","b","c"],n=new sn,r=new sn;return function(o,a=null,l=null){const c=a||l?n:null;if(this.intersectsTriangle(o,c))return(a||l)&&(a&&c.getCenter(a),l&&c.getCenter(l)),0;let u=1/0;for(let d=0;d<3;d++){let f;const m=e[d],v=o[m];this.closestPointToPoint(v,i),f=v.distanceToSquared(i),f<u&&(u=f,a&&a.copy(i),l&&l.copy(v));const S=this[m];o.closestPointToPoint(S,i),f=S.distanceToSquared(i),f<u&&(u=f,a&&a.copy(S),l&&l.copy(i))}for(let d=0;d<3;d++){const f=e[d],m=e[(d+1)%3];n.set(this[f],this[m]);for(let v=0;v<3;v++){const S=e[v],p=e[(v+1)%3];r.set(o[S],o[p]),Ul(n,r,i,t);const h=i.distanceToSquared(t);h<u&&(u=h,a&&a.copy(i),l&&l.copy(t))}}return Math.sqrt(u)}}();class De{constructor(t,e,n){this.isOrientedBox=!0,this.min=new z,this.max=new z,this.matrix=new $t,this.invMatrix=new $t,this.points=new Array(8).fill().map(()=>new z),this.satAxes=new Array(3).fill().map(()=>new z),this.satBounds=new Array(3).fill().map(()=>new Hn),this.alignedSatBounds=new Array(3).fill().map(()=>new Hn),this.needsUpdate=!1,t&&this.min.copy(t),e&&this.max.copy(e),n&&this.matrix.copy(n)}set(t,e,n){this.min.copy(t),this.max.copy(e),this.matrix.copy(n),this.needsUpdate=!0}copy(t){this.min.copy(t.min),this.max.copy(t.max),this.matrix.copy(t.matrix),this.needsUpdate=!0}}De.prototype.update=function(){return function(){const t=this.matrix,e=this.min,n=this.max,r=this.points;for(let c=0;c<=1;c++)for(let u=0;u<=1;u++)for(let d=0;d<=1;d++){const f=1*c|2*u|4*d,m=r[f];m.x=c?n.x:e.x,m.y=u?n.y:e.y,m.z=d?n.z:e.z,m.applyMatrix4(t)}const s=this.satBounds,o=this.satAxes,a=r[0];for(let c=0;c<3;c++){const u=o[c],d=s[c],f=1<<c,m=r[f];u.subVectors(a,m),d.setFromPoints(u,r)}const l=this.alignedSatBounds;l[0].setFromPointsField(r,"x"),l[1].setFromPointsField(r,"y"),l[2].setFromPointsField(r,"z"),this.invMatrix.copy(this.matrix).invert(),this.needsUpdate=!1}}();De.prototype.intersectsBox=function(){const i=new Hn;return function(e){this.needsUpdate&&this.update();const n=e.min,r=e.max,s=this.satBounds,o=this.satAxes,a=this.alignedSatBounds;if(i.min=n.x,i.max=r.x,a[0].isSeparated(i)||(i.min=n.y,i.max=r.y,a[1].isSeparated(i))||(i.min=n.z,i.max=r.z,a[2].isSeparated(i)))return!1;for(let l=0;l<3;l++){const c=o[l],u=s[l];if(i.setFromBox(c,e),u.isSeparated(i))return!1}return!0}}();De.prototype.intersectsTriangle=function(){const i=new on,t=new Array(3),e=new Hn,n=new Hn,r=new z;return function(o){this.needsUpdate&&this.update(),o.isExtendedTriangle?o.needsUpdate&&o.update():(i.copy(o),i.update(),o=i);const a=this.satBounds,l=this.satAxes;t[0]=o.a,t[1]=o.b,t[2]=o.c;for(let f=0;f<3;f++){const m=a[f],v=l[f];if(e.setFromPoints(v,t),m.isSeparated(e))return!1}const c=o.satBounds,u=o.satAxes,d=this.points;for(let f=0;f<3;f++){const m=c[f],v=u[f];if(e.setFromPoints(v,d),m.isSeparated(e))return!1}for(let f=0;f<3;f++){const m=l[f];for(let v=0;v<4;v++){const S=u[v];if(r.crossVectors(m,S),e.setFromPoints(r,t),n.setFromPoints(r,d),e.isSeparated(n))return!1}}return!0}}();De.prototype.closestPointToPoint=function(){return function(t,e){return this.needsUpdate&&this.update(),e.copy(t).applyMatrix4(this.invMatrix).clamp(this.min,this.max).applyMatrix4(this.matrix),e}}();De.prototype.distanceToPoint=function(){const i=new z;return function(e){return this.closestPointToPoint(e,i),e.distanceTo(i)}}();De.prototype.distanceToBox=function(){const i=["x","y","z"],t=new Array(12).fill().map(()=>new sn),e=new Array(12).fill().map(()=>new sn),n=new z,r=new z;return function(o,a=0,l=null,c=null){if(this.needsUpdate&&this.update(),this.intersectsBox(o))return(l||c)&&(o.getCenter(r),this.closestPointToPoint(r,n),o.closestPointToPoint(n,r),l&&l.copy(n),c&&c.copy(r)),0;const u=a*a,d=o.min,f=o.max,m=this.points;let v=1/0;for(let p=0;p<8;p++){const h=m[p];r.copy(h).clamp(d,f);const M=h.distanceToSquared(r);if(M<v&&(v=M,l&&l.copy(h),c&&c.copy(r),M<u))return Math.sqrt(M)}let S=0;for(let p=0;p<3;p++)for(let h=0;h<=1;h++)for(let M=0;M<=1;M++){const y=(p+1)%3,E=(p+2)%3,C=h<<y|M<<E,A=1<<p|h<<y|M<<E,b=m[C],x=m[A];t[S].set(b,x);const g=i[p],w=i[y],P=i[E],U=e[S],F=U.start,k=U.end;F[g]=d[g],F[w]=h?d[w]:f[w],F[P]=M?d[P]:f[w],k[g]=f[g],k[w]=h?d[w]:f[w],k[P]=M?d[P]:f[w],S++}for(let p=0;p<=1;p++)for(let h=0;h<=1;h++)for(let M=0;M<=1;M++){r.x=p?f.x:d.x,r.y=h?f.y:d.y,r.z=M?f.z:d.z,this.closestPointToPoint(r,n);const y=r.distanceToSquared(n);if(y<v&&(v=y,l&&l.copy(n),c&&c.copy(r),y<u))return Math.sqrt(y)}for(let p=0;p<12;p++){const h=t[p];for(let M=0;M<12;M++){const y=e[M];Ul(h,y,n,r);const E=n.distanceToSquared(r);if(E<v&&(v=E,l&&l.copy(n),c&&c.copy(r),E<u))return Math.sqrt(E)}}return Math.sqrt(v)}}();class Nl{constructor(t){this._getNewPrimitive=t,this._primitives=[]}getPrimitive(){const t=this._primitives;return t.length===0?this._getNewPrimitive():t.pop()}releasePrimitive(t){this._primitives.push(t)}}class fv extends Nl{constructor(){super(()=>new on)}}const rn=new fv;class dv{constructor(){this.float32Array=null,this.uint16Array=null,this.uint32Array=null;const t=[];let e=null;this.setBuffer=n=>{e&&t.push(e),e=n,this.float32Array=new Float32Array(n),this.uint16Array=new Uint16Array(n),this.uint32Array=new Uint32Array(n)},this.clearBuffer=()=>{e=null,this.float32Array=null,this.uint16Array=null,this.uint32Array=null,t.length!==0&&this.setBuffer(t.pop())}}}const ne=new dv;let si,dr;const nr=[],Ps=new Nl(()=>new Ie);function pv(i,t,e,n,r,s){si=Ps.getPrimitive(),dr=Ps.getPrimitive(),nr.push(si,dr),ne.setBuffer(i._roots[t]);const o=fl(0,i.geometry,e,n,r,s);ne.clearBuffer(),Ps.releasePrimitive(si),Ps.releasePrimitive(dr),nr.pop(),nr.pop();const a=nr.length;return a>0&&(dr=nr[a-1],si=nr[a-2]),o}function fl(i,t,e,n,r=null,s=0,o=0){const{float32Array:a,uint16Array:l,uint32Array:c}=ne;let u=i*2;if(Fe(u,l)){const v=Xe(i,c),S=tn(u,l);return ae(i,a,si),n(v,S,!1,o,s+i,si)}else{let P=function(F){const{uint16Array:k,uint32Array:B}=ne;let V=F*2;for(;!Fe(V,k);)F=en(F),V=F*2;return Xe(F,B)},U=function(F){const{uint16Array:k,uint32Array:B}=ne;let V=F*2;for(;!Fe(V,k);)F=nn(F,B),V=F*2;return Xe(F,B)+tn(V,k)};var f=P,m=U;const v=en(i),S=nn(i,c);let p=v,h=S,M,y,E,C;if(r&&(E=si,C=dr,ae(p,a,E),ae(h,a,C),M=r(E),y=r(C),y<M)){p=S,h=v;const F=M;M=y,y=F,E=C}E||(E=si,ae(p,a,E));const A=Fe(p*2,l),b=e(E,A,M,o+1,s+p);let x;if(b===Zc){const F=P(p),B=U(p)-F;x=n(F,B,!0,o+1,s+p,E)}else x=b&&fl(p,t,e,n,r,s,o+1);if(x)return!0;C=dr,ae(h,a,C);const _=Fe(h*2,l),g=e(C,_,y,o+1,s+h);let w;if(g===Zc){const F=P(h),B=U(h)-F;w=n(F,B,!0,o+1,s+h,C)}else w=g&&fl(h,t,e,n,r,s,o+1);return!!w}}const Ur=new z,ua=new z;function mv(i,t,e={},n=0,r=1/0){const s=n*n,o=r*r;let a=1/0,l=null;if(i.shapecast({boundsTraverseOrder:u=>(Ur.copy(t).clamp(u.min,u.max),Ur.distanceToSquared(t)),intersectsBounds:(u,d,f)=>f<a&&f<o,intersectsTriangle:(u,d)=>{u.closestPointToPoint(t,Ur);const f=t.distanceToSquared(Ur);return f<a&&(ua.copy(Ur),a=f,l=d),f<s}}),a===1/0)return null;const c=Math.sqrt(a);return e.point?e.point.copy(ua):e.point=ua.clone(),e.distance=c,e.faceIndex=l,e}const gv=parseInt(go)>=169,vi=new z,xi=new z,yi=new z,Ls=new Rt,Is=new Rt,Ds=new Rt,nu=new z,iu=new z,ru=new z,Nr=new z;function _v(i,t,e,n,r,s,o,a){let l;if(s===Pe?l=i.intersectTriangle(n,e,t,!0,r):l=i.intersectTriangle(t,e,n,s!==Ze,r),l===null)return null;const c=i.origin.distanceTo(r);return c<o||c>a?null:{distance:c,point:r.clone()}}function vv(i,t,e,n,r,s,o,a,l,c,u){vi.fromBufferAttribute(t,s),xi.fromBufferAttribute(t,o),yi.fromBufferAttribute(t,a);const d=_v(i,vi,xi,yi,Nr,l,c,u);if(d){const f=new z;re.getBarycoord(Nr,vi,xi,yi,f),n&&(Ls.fromBufferAttribute(n,s),Is.fromBufferAttribute(n,o),Ds.fromBufferAttribute(n,a),d.uv=re.getInterpolation(Nr,vi,xi,yi,Ls,Is,Ds,new Rt)),r&&(Ls.fromBufferAttribute(r,s),Is.fromBufferAttribute(r,o),Ds.fromBufferAttribute(r,a),d.uv1=re.getInterpolation(Nr,vi,xi,yi,Ls,Is,Ds,new Rt)),e&&(nu.fromBufferAttribute(e,s),iu.fromBufferAttribute(e,o),ru.fromBufferAttribute(e,a),d.normal=re.getInterpolation(Nr,vi,xi,yi,nu,iu,ru,new z),d.normal.dot(i.direction)>0&&d.normal.multiplyScalar(-1));const m={a:s,b:o,c:a,normal:new z,materialIndex:0};re.getNormal(vi,xi,yi,m.normal),d.face=m,d.faceIndex=s,gv&&(d.barycoord=f)}return d}function Eo(i,t,e,n,r,s,o){const a=n*3;let l=a+0,c=a+1,u=a+2;const d=i.index;i.index&&(l=d.getX(l),c=d.getX(c),u=d.getX(u));const{position:f,normal:m,uv:v,uv1:S}=i.attributes,p=vv(e,f,m,v,S,l,c,u,t,s,o);return p?(p.faceIndex=n,r&&r.push(p),p):null}function de(i,t,e,n){const r=i.a,s=i.b,o=i.c;let a=t,l=t+1,c=t+2;e&&(a=e.getX(a),l=e.getX(l),c=e.getX(c)),r.x=n.getX(a),r.y=n.getY(a),r.z=n.getZ(a),s.x=n.getX(l),s.y=n.getY(l),s.z=n.getZ(l),o.x=n.getX(c),o.y=n.getY(c),o.z=n.getZ(c)}function xv(i,t,e,n,r,s,o,a){const{geometry:l,_indirectBuffer:c}=i;for(let u=n,d=n+r;u<d;u++)Eo(l,t,e,u,s,o,a)}function yv(i,t,e,n,r,s,o){const{geometry:a,_indirectBuffer:l}=i;let c=1/0,u=null;for(let d=n,f=n+r;d<f;d++){let m;m=Eo(a,t,e,d,null,s,o),m&&m.distance<c&&(u=m,c=m.distance)}return u}function Mv(i,t,e,n,r,s,o){const{geometry:a}=e,{index:l}=a,c=a.attributes.position;for(let u=i,d=t+i;u<d;u++){let f;if(f=u,de(o,f*3,l,c),o.needsUpdate=!0,n(o,f,r,s))return!0}return!1}function Sv(i,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=i.geometry,n=e.index?e.index.array:null,r=e.attributes.position;let s,o,a,l,c=0;const u=i._roots;for(let f=0,m=u.length;f<m;f++)s=u[f],o=new Uint32Array(s),a=new Uint16Array(s),l=new Float32Array(s),d(0,c),c+=s.byteLength;function d(f,m,v=!1){const S=f*2;if(a[S+15]===So){const h=o[f+6],M=a[S+14];let y=1/0,E=1/0,C=1/0,A=-1/0,b=-1/0,x=-1/0;for(let _=3*h,g=3*(h+M);_<g;_++){let w=n[_];const P=r.getX(w),U=r.getY(w),F=r.getZ(w);P<y&&(y=P),P>A&&(A=P),U<E&&(E=U),U>b&&(b=U),F<C&&(C=F),F>x&&(x=F)}return l[f+0]!==y||l[f+1]!==E||l[f+2]!==C||l[f+3]!==A||l[f+4]!==b||l[f+5]!==x?(l[f+0]=y,l[f+1]=E,l[f+2]=C,l[f+3]=A,l[f+4]=b,l[f+5]=x,!0):!1}else{const h=f+8,M=o[f+6],y=h+m,E=M+m;let C=v,A=!1,b=!1;t?C||(A=t.has(y),b=t.has(E),C=!A&&!b):(A=!0,b=!0);const x=C||A,_=C||b;let g=!1;x&&(g=d(h,m,C));let w=!1;_&&(w=d(M,m,C));const P=g||w;if(P)for(let U=0;U<3;U++){const F=h+U,k=M+U,B=l[F],V=l[F+3],Y=l[k],et=l[k+3];l[f+U]=B<Y?B:Y,l[f+U+3]=V>et?V:et}return P}}}function ui(i,t,e,n,r){let s,o,a,l,c,u;const d=1/e.direction.x,f=1/e.direction.y,m=1/e.direction.z,v=e.origin.x,S=e.origin.y,p=e.origin.z;let h=t[i],M=t[i+3],y=t[i+1],E=t[i+3+1],C=t[i+2],A=t[i+3+2];return d>=0?(s=(h-v)*d,o=(M-v)*d):(s=(M-v)*d,o=(h-v)*d),f>=0?(a=(y-S)*f,l=(E-S)*f):(a=(E-S)*f,l=(y-S)*f),s>l||a>o||((a>s||isNaN(s))&&(s=a),(l<o||isNaN(o))&&(o=l),m>=0?(c=(C-p)*m,u=(A-p)*m):(c=(A-p)*m,u=(C-p)*m),s>u||c>o)?!1:((c>s||s!==s)&&(s=c),(u<o||o!==o)&&(o=u),s<=r&&o>=n)}function Ev(i,t,e,n,r,s,o,a){const{geometry:l,_indirectBuffer:c}=i;for(let u=n,d=n+r;u<d;u++){let f=c?c[u]:u;Eo(l,t,e,f,s,o,a)}}function bv(i,t,e,n,r,s,o){const{geometry:a,_indirectBuffer:l}=i;let c=1/0,u=null;for(let d=n,f=n+r;d<f;d++){let m;m=Eo(a,t,e,l?l[d]:d,null,s,o),m&&m.distance<c&&(u=m,c=m.distance)}return u}function Av(i,t,e,n,r,s,o){const{geometry:a}=e,{index:l}=a,c=a.attributes.position;for(let u=i,d=t+i;u<d;u++){let f;if(f=e.resolveTriangleIndex(u),de(o,f*3,l,c),o.needsUpdate=!0,n(o,f,r,s))return!0}return!1}function wv(i,t,e,n,r,s,o){ne.setBuffer(i._roots[t]),dl(0,i,e,n,r,s,o),ne.clearBuffer()}function dl(i,t,e,n,r,s,o){const{float32Array:a,uint16Array:l,uint32Array:c}=ne,u=i*2;if(Fe(u,l)){const f=Xe(i,c),m=tn(u,l);xv(t,e,n,f,m,r,s,o)}else{const f=en(i);ui(f,a,n,s,o)&&dl(f,t,e,n,r,s,o);const m=nn(i,c);ui(m,a,n,s,o)&&dl(m,t,e,n,r,s,o)}}const Tv=["x","y","z"];function Cv(i,t,e,n,r,s){ne.setBuffer(i._roots[t]);const o=pl(0,i,e,n,r,s);return ne.clearBuffer(),o}function pl(i,t,e,n,r,s){const{float32Array:o,uint16Array:a,uint32Array:l}=ne;let c=i*2;if(Fe(c,a)){const d=Xe(i,l),f=tn(c,a);return yv(t,e,n,d,f,r,s)}else{const d=wh(i,l),f=Tv[d],v=n.direction[f]>=0;let S,p;v?(S=en(i),p=nn(i,l)):(S=nn(i,l),p=en(i));const M=ui(S,o,n,r,s)?pl(S,t,e,n,r,s):null;if(M){const C=M.point[f];if(v?C<=o[p+d]:C>=o[p+d+3])return M}const E=ui(p,o,n,r,s)?pl(p,t,e,n,r,s):null;return M&&E?M.distance<=E.distance?M:E:M||E||null}}const Us=new Ie,ir=new on,rr=new on,Fr=new $t,su=new De,Ns=new De;function Rv(i,t,e,n){ne.setBuffer(i._roots[t]);const r=ml(0,i,e,n);return ne.clearBuffer(),r}function ml(i,t,e,n,r=null){const{float32Array:s,uint16Array:o,uint32Array:a}=ne;let l=i*2;if(r===null&&(e.boundingBox||e.computeBoundingBox(),su.set(e.boundingBox.min,e.boundingBox.max,n),r=su),Fe(l,o)){const u=t.geometry,d=u.index,f=u.attributes.position,m=e.index,v=e.attributes.position,S=Xe(i,a),p=tn(l,o);if(Fr.copy(n).invert(),e.boundsTree)return ae(i,s,Ns),Ns.matrix.copy(Fr),Ns.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:M=>Ns.intersectsBox(M),intersectsTriangle:M=>{M.a.applyMatrix4(n),M.b.applyMatrix4(n),M.c.applyMatrix4(n),M.needsUpdate=!0;for(let y=S*3,E=(p+S)*3;y<E;y+=3)if(de(rr,y,d,f),rr.needsUpdate=!0,M.intersectsTriangle(rr))return!0;return!1}});for(let h=S*3,M=(p+S)*3;h<M;h+=3){de(ir,h,d,f),ir.a.applyMatrix4(Fr),ir.b.applyMatrix4(Fr),ir.c.applyMatrix4(Fr),ir.needsUpdate=!0;for(let y=0,E=m.count;y<E;y+=3)if(de(rr,y,m,v),rr.needsUpdate=!0,ir.intersectsTriangle(rr))return!0}}else{const u=i+8,d=a[i+6];return ae(u,s,Us),!!(r.intersectsBox(Us)&&ml(u,t,e,n,r)||(ae(d,s,Us),r.intersectsBox(Us)&&ml(d,t,e,n,r)))}}const Fs=new $t,ha=new De,Or=new De,Pv=new z,Lv=new z,Iv=new z,Dv=new z;function Uv(i,t,e,n={},r={},s=0,o=1/0){t.boundingBox||t.computeBoundingBox(),ha.set(t.boundingBox.min,t.boundingBox.max,e),ha.needsUpdate=!0;const a=i.geometry,l=a.attributes.position,c=a.index,u=t.attributes.position,d=t.index,f=rn.getPrimitive(),m=rn.getPrimitive();let v=Pv,S=Lv,p=null,h=null;r&&(p=Iv,h=Dv);let M=1/0,y=null,E=null;return Fs.copy(e).invert(),Or.matrix.copy(Fs),i.shapecast({boundsTraverseOrder:C=>ha.distanceToBox(C),intersectsBounds:(C,A,b)=>b<M&&b<o?(A&&(Or.min.copy(C.min),Or.max.copy(C.max),Or.needsUpdate=!0),!0):!1,intersectsRange:(C,A)=>{if(t.boundsTree)return t.boundsTree.shapecast({boundsTraverseOrder:x=>Or.distanceToBox(x),intersectsBounds:(x,_,g)=>g<M&&g<o,intersectsRange:(x,_)=>{for(let g=x,w=x+_;g<w;g++){de(m,3*g,d,u),m.a.applyMatrix4(e),m.b.applyMatrix4(e),m.c.applyMatrix4(e),m.needsUpdate=!0;for(let P=C,U=C+A;P<U;P++){de(f,3*P,c,l),f.needsUpdate=!0;const F=f.distanceToTriangle(m,v,p);if(F<M&&(S.copy(v),h&&h.copy(p),M=F,y=P,E=g),F<s)return!0}}}});{const b=Tr(t);for(let x=0,_=b;x<_;x++){de(m,3*x,d,u),m.a.applyMatrix4(e),m.b.applyMatrix4(e),m.c.applyMatrix4(e),m.needsUpdate=!0;for(let g=C,w=C+A;g<w;g++){de(f,3*g,c,l),f.needsUpdate=!0;const P=f.distanceToTriangle(m,v,p);if(P<M&&(S.copy(v),h&&h.copy(p),M=P,y=g,E=x),P<s)return!0}}}}}),rn.releasePrimitive(f),rn.releasePrimitive(m),M===1/0?null:(n.point?n.point.copy(S):n.point=S.clone(),n.distance=M,n.faceIndex=y,r&&(r.point?r.point.copy(h):r.point=h.clone(),r.point.applyMatrix4(Fs),S.applyMatrix4(Fs),r.distance=S.sub(r.point).length(),r.faceIndex=E),n)}function Nv(i,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=i.geometry,n=e.index?e.index.array:null,r=e.attributes.position;let s,o,a,l,c=0;const u=i._roots;for(let f=0,m=u.length;f<m;f++)s=u[f],o=new Uint32Array(s),a=new Uint16Array(s),l=new Float32Array(s),d(0,c),c+=s.byteLength;function d(f,m,v=!1){const S=f*2;if(a[S+15]===So){const h=o[f+6],M=a[S+14];let y=1/0,E=1/0,C=1/0,A=-1/0,b=-1/0,x=-1/0;for(let _=h,g=h+M;_<g;_++){const w=3*i.resolveTriangleIndex(_);for(let P=0;P<3;P++){let U=w+P;U=n?n[U]:U;const F=r.getX(U),k=r.getY(U),B=r.getZ(U);F<y&&(y=F),F>A&&(A=F),k<E&&(E=k),k>b&&(b=k),B<C&&(C=B),B>x&&(x=B)}}return l[f+0]!==y||l[f+1]!==E||l[f+2]!==C||l[f+3]!==A||l[f+4]!==b||l[f+5]!==x?(l[f+0]=y,l[f+1]=E,l[f+2]=C,l[f+3]=A,l[f+4]=b,l[f+5]=x,!0):!1}else{const h=f+8,M=o[f+6],y=h+m,E=M+m;let C=v,A=!1,b=!1;t?C||(A=t.has(y),b=t.has(E),C=!A&&!b):(A=!0,b=!0);const x=C||A,_=C||b;let g=!1;x&&(g=d(h,m,C));let w=!1;_&&(w=d(M,m,C));const P=g||w;if(P)for(let U=0;U<3;U++){const F=h+U,k=M+U,B=l[F],V=l[F+3],Y=l[k],et=l[k+3];l[f+U]=B<Y?B:Y,l[f+U+3]=V>et?V:et}return P}}}function Fv(i,t,e,n,r,s,o){ne.setBuffer(i._roots[t]),gl(0,i,e,n,r,s,o),ne.clearBuffer()}function gl(i,t,e,n,r,s,o){const{float32Array:a,uint16Array:l,uint32Array:c}=ne,u=i*2;if(Fe(u,l)){const f=Xe(i,c),m=tn(u,l);Ev(t,e,n,f,m,r,s,o)}else{const f=en(i);ui(f,a,n,s,o)&&gl(f,t,e,n,r,s,o);const m=nn(i,c);ui(m,a,n,s,o)&&gl(m,t,e,n,r,s,o)}}const Ov=["x","y","z"];function Bv(i,t,e,n,r,s){ne.setBuffer(i._roots[t]);const o=_l(0,i,e,n,r,s);return ne.clearBuffer(),o}function _l(i,t,e,n,r,s){const{float32Array:o,uint16Array:a,uint32Array:l}=ne;let c=i*2;if(Fe(c,a)){const d=Xe(i,l),f=tn(c,a);return bv(t,e,n,d,f,r,s)}else{const d=wh(i,l),f=Ov[d],v=n.direction[f]>=0;let S,p;v?(S=en(i),p=nn(i,l)):(S=nn(i,l),p=en(i));const M=ui(S,o,n,r,s)?_l(S,t,e,n,r,s):null;if(M){const C=M.point[f];if(v?C<=o[p+d]:C>=o[p+d+3])return M}const E=ui(p,o,n,r,s)?_l(p,t,e,n,r,s):null;return M&&E?M.distance<=E.distance?M:E:M||E||null}}const Os=new Ie,sr=new on,or=new on,Br=new $t,ou=new De,Bs=new De;function zv(i,t,e,n){ne.setBuffer(i._roots[t]);const r=vl(0,i,e,n);return ne.clearBuffer(),r}function vl(i,t,e,n,r=null){const{float32Array:s,uint16Array:o,uint32Array:a}=ne;let l=i*2;if(r===null&&(e.boundingBox||e.computeBoundingBox(),ou.set(e.boundingBox.min,e.boundingBox.max,n),r=ou),Fe(l,o)){const u=t.geometry,d=u.index,f=u.attributes.position,m=e.index,v=e.attributes.position,S=Xe(i,a),p=tn(l,o);if(Br.copy(n).invert(),e.boundsTree)return ae(i,s,Bs),Bs.matrix.copy(Br),Bs.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:M=>Bs.intersectsBox(M),intersectsTriangle:M=>{M.a.applyMatrix4(n),M.b.applyMatrix4(n),M.c.applyMatrix4(n),M.needsUpdate=!0;for(let y=S,E=p+S;y<E;y++)if(de(or,3*t.resolveTriangleIndex(y),d,f),or.needsUpdate=!0,M.intersectsTriangle(or))return!0;return!1}});for(let h=S,M=p+S;h<M;h++){const y=t.resolveTriangleIndex(h);de(sr,3*y,d,f),sr.a.applyMatrix4(Br),sr.b.applyMatrix4(Br),sr.c.applyMatrix4(Br),sr.needsUpdate=!0;for(let E=0,C=m.count;E<C;E+=3)if(de(or,E,m,v),or.needsUpdate=!0,sr.intersectsTriangle(or))return!0}}else{const u=i+8,d=a[i+6];return ae(u,s,Os),!!(r.intersectsBox(Os)&&vl(u,t,e,n,r)||(ae(d,s,Os),r.intersectsBox(Os)&&vl(d,t,e,n,r)))}}const zs=new $t,fa=new De,zr=new De,kv=new z,Hv=new z,Vv=new z,Gv=new z;function Wv(i,t,e,n={},r={},s=0,o=1/0){t.boundingBox||t.computeBoundingBox(),fa.set(t.boundingBox.min,t.boundingBox.max,e),fa.needsUpdate=!0;const a=i.geometry,l=a.attributes.position,c=a.index,u=t.attributes.position,d=t.index,f=rn.getPrimitive(),m=rn.getPrimitive();let v=kv,S=Hv,p=null,h=null;r&&(p=Vv,h=Gv);let M=1/0,y=null,E=null;return zs.copy(e).invert(),zr.matrix.copy(zs),i.shapecast({boundsTraverseOrder:C=>fa.distanceToBox(C),intersectsBounds:(C,A,b)=>b<M&&b<o?(A&&(zr.min.copy(C.min),zr.max.copy(C.max),zr.needsUpdate=!0),!0):!1,intersectsRange:(C,A)=>{if(t.boundsTree){const b=t.boundsTree;return b.shapecast({boundsTraverseOrder:x=>zr.distanceToBox(x),intersectsBounds:(x,_,g)=>g<M&&g<o,intersectsRange:(x,_)=>{for(let g=x,w=x+_;g<w;g++){const P=b.resolveTriangleIndex(g);de(m,3*P,d,u),m.a.applyMatrix4(e),m.b.applyMatrix4(e),m.c.applyMatrix4(e),m.needsUpdate=!0;for(let U=C,F=C+A;U<F;U++){const k=i.resolveTriangleIndex(U);de(f,3*k,c,l),f.needsUpdate=!0;const B=f.distanceToTriangle(m,v,p);if(B<M&&(S.copy(v),h&&h.copy(p),M=B,y=U,E=g),B<s)return!0}}}})}else{const b=Tr(t);for(let x=0,_=b;x<_;x++){de(m,3*x,d,u),m.a.applyMatrix4(e),m.b.applyMatrix4(e),m.c.applyMatrix4(e),m.needsUpdate=!0;for(let g=C,w=C+A;g<w;g++){const P=i.resolveTriangleIndex(g);de(f,3*P,c,l),f.needsUpdate=!0;const U=f.distanceToTriangle(m,v,p);if(U<M&&(S.copy(v),h&&h.copy(p),M=U,y=g,E=x),U<s)return!0}}}}}),rn.releasePrimitive(f),rn.releasePrimitive(m),M===1/0?null:(n.point?n.point.copy(S):n.point=S.clone(),n.distance=M,n.faceIndex=y,r&&(r.point?r.point.copy(h):r.point=h.clone(),r.point.applyMatrix4(zs),S.applyMatrix4(zs),r.distance=S.sub(r.point).length(),r.faceIndex=E),n)}function Xv(){return typeof SharedArrayBuffer<"u"}const jr=new ne.constructor,ho=new ne.constructor,ei=new Nl(()=>new Ie),ar=new Ie,lr=new Ie,da=new Ie,pa=new Ie;let ma=!1;function Yv(i,t,e,n){if(ma)throw new Error("MeshBVH: Recursive calls to bvhcast not supported.");ma=!0;const r=i._roots,s=t._roots;let o,a=0,l=0;const c=new $t().copy(e).invert();for(let u=0,d=r.length;u<d;u++){jr.setBuffer(r[u]),l=0;const f=ei.getPrimitive();ae(0,jr.float32Array,f),f.applyMatrix4(c);for(let m=0,v=s.length;m<v&&(ho.setBuffer(s[m]),o=fn(0,0,e,c,n,a,l,0,0,f),ho.clearBuffer(),l+=s[m].length,!o);m++);if(ei.releasePrimitive(f),jr.clearBuffer(),a+=r[u].length,o)break}return ma=!1,o}function fn(i,t,e,n,r,s=0,o=0,a=0,l=0,c=null,u=!1){let d,f;u?(d=ho,f=jr):(d=jr,f=ho);const m=d.float32Array,v=d.uint32Array,S=d.uint16Array,p=f.float32Array,h=f.uint32Array,M=f.uint16Array,y=i*2,E=t*2,C=Fe(y,S),A=Fe(E,M);let b=!1;if(A&&C)u?b=r(Xe(t,h),tn(t*2,M),Xe(i,v),tn(i*2,S),l,o+t,a,s+i):b=r(Xe(i,v),tn(i*2,S),Xe(t,h),tn(t*2,M),a,s+i,l,o+t);else if(A){const x=ei.getPrimitive();ae(t,p,x),x.applyMatrix4(e);const _=en(i),g=nn(i,v);ae(_,m,ar),ae(g,m,lr);const w=x.intersectsBox(ar),P=x.intersectsBox(lr);b=w&&fn(t,_,n,e,r,o,s,l,a+1,x,!u)||P&&fn(t,g,n,e,r,o,s,l,a+1,x,!u),ei.releasePrimitive(x)}else{const x=en(t),_=nn(t,h);ae(x,p,da),ae(_,p,pa);const g=c.intersectsBox(da),w=c.intersectsBox(pa);if(g&&w)b=fn(i,x,e,n,r,s,o,a,l+1,c,u)||fn(i,_,e,n,r,s,o,a,l+1,c,u);else if(g)if(C)b=fn(i,x,e,n,r,s,o,a,l+1,c,u);else{const P=ei.getPrimitive();P.copy(da).applyMatrix4(e);const U=en(i),F=nn(i,v);ae(U,m,ar),ae(F,m,lr);const k=P.intersectsBox(ar),B=P.intersectsBox(lr);b=k&&fn(x,U,n,e,r,o,s,l,a+1,P,!u)||B&&fn(x,F,n,e,r,o,s,l,a+1,P,!u),ei.releasePrimitive(P)}else if(w)if(C)b=fn(i,_,e,n,r,s,o,a,l+1,c,u);else{const P=ei.getPrimitive();P.copy(pa).applyMatrix4(e);const U=en(i),F=nn(i,v);ae(U,m,ar),ae(F,m,lr);const k=P.intersectsBox(ar),B=P.intersectsBox(lr);b=k&&fn(_,U,n,e,r,o,s,l,a+1,P,!u)||B&&fn(_,F,n,e,r,o,s,l,a+1,P,!u),ei.releasePrimitive(P)}}return b}const ks=new De,au=new Ie,$v={strategy:Eh,maxDepth:40,maxLeafTris:10,useSharedArrayBuffer:!1,setBoundingBox:!0,onProgress:null,indirect:!1,verbose:!0,range:null};class Fl{static serialize(t,e={}){e={cloneBuffers:!0,...e};const n=t.geometry,r=t._roots,s=t._indirectBuffer,o=n.getIndex();let a;return e.cloneBuffers?a={roots:r.map(l=>l.slice()),index:o?o.array.slice():null,indirectBuffer:s?s.slice():null}:a={roots:r,index:o?o.array:null,indirectBuffer:s},a}static deserialize(t,e,n={}){n={setIndex:!0,indirect:!!t.indirectBuffer,...n};const{index:r,roots:s,indirectBuffer:o}=t,a=new Fl(e,{...n,[oa]:!0});if(a._roots=s,a._indirectBuffer=o||null,n.setIndex){const l=e.getIndex();if(l===null){const c=new Be(t.index,1,!1);e.setIndex(c)}else l.array!==r&&(l.array.set(r),l.needsUpdate=!0)}return a}get indirect(){return!!this._indirectBuffer}constructor(t,e={}){if(t.isBufferGeometry){if(t.index&&t.index.isInterleavedBufferAttribute)throw new Error("MeshBVH: InterleavedBufferAttribute is not supported for the index attribute.")}else throw new Error("MeshBVH: Only BufferGeometries are supported.");if(e=Object.assign({...$v,[oa]:!1},e),e.useSharedArrayBuffer&&!Xv())throw new Error("MeshBVH: SharedArrayBuffer is not available.");this.geometry=t,this._roots=null,this._indirectBuffer=null,e[oa]||(lv(this,e),!t.boundingBox&&e.setBoundingBox&&(t.boundingBox=this.getBoundingBox(new Ie))),this.resolveTriangleIndex=e.indirect?n=>this._indirectBuffer[n]:n=>n}refit(t=null){return(this.indirect?Nv:Sv)(this,t)}traverse(t,e=0){const n=this._roots[e],r=new Uint32Array(n),s=new Uint16Array(n);o(0);function o(a,l=0){const c=a*2,u=s[c+15]===So;if(u){const d=r[a+6],f=s[c+14];t(l,u,new Float32Array(n,a*4,6),d,f)}else{const d=a+$r/4,f=r[a+6],m=r[a+7];t(l,u,new Float32Array(n,a*4,6),m)||(o(d,l+1),o(f,l+1))}}}raycast(t,e=yn,n=0,r=1/0){const s=this._roots,o=this.geometry,a=[],l=e.isMaterial,c=Array.isArray(e),u=o.groups,d=l?e.side:e,f=this.indirect?Fv:wv;for(let m=0,v=s.length;m<v;m++){const S=c?e[u[m].materialIndex].side:d,p=a.length;if(f(this,m,S,t,a,n,r),c){const h=u[m].materialIndex;for(let M=p,y=a.length;M<y;M++)a[M].face.materialIndex=h}}return a}raycastFirst(t,e=yn,n=0,r=1/0){const s=this._roots,o=this.geometry,a=e.isMaterial,l=Array.isArray(e);let c=null;const u=o.groups,d=a?e.side:e,f=this.indirect?Bv:Cv;for(let m=0,v=s.length;m<v;m++){const S=l?e[u[m].materialIndex].side:d,p=f(this,m,S,t,n,r);p!=null&&(c==null||p.distance<c.distance)&&(c=p,l&&(p.face.materialIndex=u[m].materialIndex))}return c}intersectsGeometry(t,e){let n=!1;const r=this._roots,s=this.indirect?zv:Rv;for(let o=0,a=r.length;o<a&&(n=s(this,o,t,e),!n);o++);return n}shapecast(t){const e=rn.getPrimitive(),n=this.indirect?Av:Mv;let{boundsTraverseOrder:r,intersectsBounds:s,intersectsRange:o,intersectsTriangle:a}=t;if(o&&a){const d=o;o=(f,m,v,S,p)=>d(f,m,v,S,p)?!0:n(f,m,this,a,v,S,e)}else o||(a?o=(d,f,m,v)=>n(d,f,this,a,m,v,e):o=(d,f,m)=>m);let l=!1,c=0;const u=this._roots;for(let d=0,f=u.length;d<f;d++){const m=u[d];if(l=pv(this,d,s,o,r,c),l)break;c+=m.byteLength}return rn.releasePrimitive(e),l}bvhcast(t,e,n){let{intersectsRanges:r,intersectsTriangles:s}=n;const o=rn.getPrimitive(),a=this.geometry.index,l=this.geometry.attributes.position,c=this.indirect?v=>{const S=this.resolveTriangleIndex(v);de(o,S*3,a,l)}:v=>{de(o,v*3,a,l)},u=rn.getPrimitive(),d=t.geometry.index,f=t.geometry.attributes.position,m=t.indirect?v=>{const S=t.resolveTriangleIndex(v);de(u,S*3,d,f)}:v=>{de(u,v*3,d,f)};if(s){const v=(S,p,h,M,y,E,C,A)=>{for(let b=h,x=h+M;b<x;b++){m(b),u.a.applyMatrix4(e),u.b.applyMatrix4(e),u.c.applyMatrix4(e),u.needsUpdate=!0;for(let _=S,g=S+p;_<g;_++)if(c(_),o.needsUpdate=!0,s(o,u,_,b,y,E,C,A))return!0}return!1};if(r){const S=r;r=function(p,h,M,y,E,C,A,b){return S(p,h,M,y,E,C,A,b)?!0:v(p,h,M,y,E,C,A,b)}}else r=v}return Yv(this,t,e,r)}intersectsBox(t,e){return ks.set(t.min,t.max,e),ks.needsUpdate=!0,this.shapecast({intersectsBounds:n=>ks.intersectsBox(n),intersectsTriangle:n=>ks.intersectsTriangle(n)})}intersectsSphere(t){return this.shapecast({intersectsBounds:e=>t.intersectsBox(e),intersectsTriangle:e=>e.intersectsSphere(t)})}closestPointToGeometry(t,e,n={},r={},s=0,o=1/0){return(this.indirect?Wv:Uv)(this,t,e,n,r,s,o)}closestPointToPoint(t,e={},n=0,r=1/0){return mv(this,t,e,n,r)}getBoundingBox(t){return t.makeEmpty(),this._roots.forEach(n=>{ae(0,new Float32Array(n),au),t.union(au)}),t}}const Rh=1e-6,jv=Rh*.5,Ph=Math.pow(10,-Math.log10(Rh)),qv=jv*Ph;function vn(i){return~~(i*Ph+qv)}function Kv(i){return`${vn(i.x)},${vn(i.y)}`}function lu(i){return`${vn(i.x)},${vn(i.y)},${vn(i.z)}`}function Zv(i){return`${vn(i.x)},${vn(i.y)},${vn(i.z)},${vn(i.w)}`}function Jv(i,t,e){e.direction.subVectors(t,i).normalize();const n=i.dot(e.direction);return e.origin.copy(i).addScaledVector(e.direction,-n),e}function Lh(){return typeof SharedArrayBuffer<"u"}function Qv(i){if(i.buffer instanceof SharedArrayBuffer)return i;const t=i.constructor,e=i.buffer,n=new SharedArrayBuffer(e.byteLength),r=new Uint8Array(e);return new Uint8Array(n).set(r,0),new t(n)}function tx(i,t=ArrayBuffer){return i>65535?new Uint32Array(new t(4*i)):new Uint16Array(new t(2*i))}function ex(i,t){if(!i.index){const e=i.attributes.position.count,n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,r=tx(e,n);i.setIndex(new Be(r,1));for(let s=0;s<e;s++)r[s]=s}}function nx(i){return i.index?i.index.count:i.attributes.position.count}function Ol(i){return nx(i)/3}const ix=1e-8,rx=new z;function sx(i){return~~(i/3)}function ox(i){return i%3}function cu(i,t){return i.start-t.start}function uu(i,t){return rx.subVectors(t,i.origin).dot(i.direction)}function ax(i,t,e,n=ix){i.sort(cu),t.sort(cu);for(let a=0;a<i.length;a++){const l=i[a];for(let c=0;c<t.length;c++){const u=t[c];if(!(u.start>l.end)){if(l.end<u.start||u.end<l.start)continue;if(l.start<=u.start&&l.end>=u.end)s(u.end,l.end)||i.splice(a+1,0,{start:u.end,end:l.end,index:l.index}),l.end=u.start,u.start=0,u.end=0;else if(l.start>=u.start&&l.end<=u.end)s(l.end,u.end)||t.splice(c+1,0,{start:l.end,end:u.end,index:u.index}),u.end=l.start,l.start=0,l.end=0;else if(l.start<=u.start&&l.end<=u.end){const d=l.end;l.end=u.start,u.start=d}else if(l.start>=u.start&&l.end>=u.end){const d=u.end;u.end=l.start,l.start=d}else throw new Error}if(e.has(l.index)||e.set(l.index,[]),e.has(u.index)||e.set(u.index,[]),e.get(l.index).push(u.index),e.get(u.index).push(l.index),o(u)&&(t.splice(c,1),c--),o(l)){i.splice(a,1),a--;break}}}r(i),r(t);function r(a){for(let l=0;l<a.length;l++)o(a[l])&&(a.splice(l,1),l--)}function s(a,l){return Math.abs(l-a)<n}function o(a){return Math.abs(a.end-a.start)<n}}const hu=1e-5,fu=1e-4;class lx{constructor(){this._rays=[]}addRay(t){this._rays.push(t)}findClosestRay(t){const e=this._rays,n=t.clone();n.direction.multiplyScalar(-1);let r=1/0,s=null;for(let l=0,c=e.length;l<c;l++){const u=e[l];if(o(u,t)&&o(u,n))continue;const d=a(u,t),f=a(u,n),m=Math.min(d,f);m<r&&(r=m,s=u)}return s;function o(l,c){const u=l.origin.distanceTo(c.origin)>hu;return l.direction.angleTo(c.direction)>fu||u}function a(l,c){const u=l.origin.distanceTo(c.origin),d=l.direction.angleTo(c.direction);return u/hu+d/fu}}}const ga=new z,_a=new z,Hs=new yo;function cx(i,t,e){const n=i.attributes,r=i.index,s=n.position,o=new Map,a=new Map,l=Array.from(t),c=new lx;for(let u=0,d=l.length;u<d;u++){const f=l[u],m=sx(f),v=ox(f);let S=3*m+v,p=3*m+(v+1)%3;r&&(S=r.getX(S),p=r.getX(p)),ga.fromBufferAttribute(s,S),_a.fromBufferAttribute(s,p),Jv(ga,_a,Hs);let h,M=c.findClosestRay(Hs);M===null&&(M=Hs.clone(),c.addRay(M)),a.has(M)||a.set(M,{forward:[],reverse:[],ray:M}),h=a.get(M);let y=uu(M,ga),E=uu(M,_a);y>E&&([y,E]=[E,y]),Hs.direction.dot(M.direction)<0?h.reverse.push({start:y,end:E,index:f}):h.forward.push({start:y,end:E,index:f})}return a.forEach(({forward:u,reverse:d},f)=>{ax(u,d,o,e),u.length===0&&d.length===0&&a.delete(f)}),{disjointConnectivityMap:o,fragmentMap:a}}const ux=new Rt,va=new z,hx=new te,xa=["","",""];class fx{constructor(t=null){this.data=null,this.disjointConnections=null,this.unmatchedDisjointEdges=null,this.unmatchedEdges=-1,this.matchedEdges=-1,this.useDrawRange=!0,this.useAllAttributes=!1,this.matchDisjointEdges=!1,this.degenerateEpsilon=1e-8,t&&this.updateFrom(t)}getSiblingTriangleIndex(t,e){const n=this.data[t*3+e];return n===-1?-1:~~(n/3)}getSiblingEdgeIndex(t,e){const n=this.data[t*3+e];return n===-1?-1:n%3}getDisjointSiblingTriangleIndices(t,e){const n=t*3+e,r=this.disjointConnections.get(n);return r?r.map(s=>~~(s/3)):[]}getDisjointSiblingEdgeIndices(t,e){const n=t*3+e,r=this.disjointConnections.get(n);return r?r.map(s=>s%3):[]}isFullyConnected(){return this.unmatchedEdges===0}updateFrom(t){const{useAllAttributes:e,useDrawRange:n,matchDisjointEdges:r,degenerateEpsilon:s}=this,o=e?y:M,a=new Map,{attributes:l}=t,c=e?Object.keys(l):null,u=t.index,d=l.position;let f=Ol(t);const m=f;let v=0;n&&(v=t.drawRange.start,t.drawRange.count!==1/0&&(f=~~(t.drawRange.count/3)));let S=this.data;(!S||S.length<3*m)&&(S=new Int32Array(3*m)),S.fill(-1);let p=0,h=new Set;for(let E=v,C=f*3+v;E<C;E+=3){const A=E;for(let b=0;b<3;b++){let x=A+b;u&&(x=u.getX(x)),xa[b]=o(x)}for(let b=0;b<3;b++){const x=(b+1)%3,_=xa[b],g=xa[x],w=`${g}_${_}`;if(a.has(w)){const P=A+b,U=a.get(w);S[P]=U,S[U]=P,a.delete(w),p+=2,h.delete(U)}else{const P=`${_}_${g}`,U=A+b;a.set(P,U),h.add(U)}}}if(r){const{fragmentMap:E,disjointConnectivityMap:C}=cx(t,h,s);h.clear(),E.forEach(({forward:A,reverse:b})=>{A.forEach(({index:x})=>h.add(x)),b.forEach(({index:x})=>h.add(x))}),this.unmatchedDisjointEdges=E,this.disjointConnections=C,p=f*3-h.size}this.matchedEdges=p,this.unmatchedEdges=h.size,this.data=S;function M(E){return va.fromBufferAttribute(d,E),lu(va)}function y(E){let C="";for(let A=0,b=c.length;A<b;A++){const x=l[c[A]];let _;switch(x.itemSize){case 1:_=vn(x.getX(E));break;case 2:_=Kv(ux.fromBufferAttribute(x,E));break;case 3:_=lu(va.fromBufferAttribute(x,E));break;case 4:_=Zv(hx.fromBufferAttribute(x,E));break}C!==""&&(C+="|"),C+=_}return C}}}class fo extends Qe{constructor(...t){super(...t),this.isBrush=!0,this._previousMatrix=new $t,this._previousMatrix.elements.fill(0)}markUpdated(){this._previousMatrix.copy(this.matrix)}isDirty(){const{matrix:t,_previousMatrix:e}=this,n=t.elements,r=e.elements;for(let s=0;s<16;s++)if(n[s]!==r[s])return!0;return!1}prepareGeometry(){const t=this.geometry,e=t.attributes,n=Lh();if(n)for(const r in e){const s=e[r];if(s.isInterleavedBufferAttribute)throw new Error("Brush: InterleavedBufferAttributes are not supported.");s.array=Qv(s.array)}if(t.boundsTree||(ex(t,{useSharedArrayBuffer:n}),t.boundsTree=new Fl(t,{maxLeafTris:3,indirect:!0,useSharedArrayBuffer:n})),t.halfEdges||(t.halfEdges=new fx(t)),!t.groupIndices){const r=Ol(t),s=new Uint16Array(r),o=t.groups;for(let a=0,l=o.length;a<l;a++){const{start:c,count:u}=o[a];for(let d=c/3,f=(c+u)/3;d<f;d++)s[d]=a}t.groupIndices=s}}disposeCacheData(){const{geometry:t}=this;t.halfEdges=null,t.boundsTree=null,t.groupIndices=null}}const dx=1e-14,ya=new z,du=new z,pu=new z;function ii(i,t=dx){ya.subVectors(i.b,i.a),du.subVectors(i.c,i.a),pu.subVectors(i.b,i.c);const e=ya.angleTo(du),n=ya.angleTo(pu),r=Math.PI-e-n;return Math.abs(e)<t||Math.abs(n)<t||Math.abs(r)<t||i.a.distanceToSquared(i.b)<t||i.a.distanceToSquared(i.c)<t||i.b.distanceToSquared(i.c)<t}const Ma=1e-10,kr=1e-10,px=1e-10,Pn=new sn,ce=new sn,Ln=new z,Sa=new z,mu=new z,Vs=new dn,Ea=new on;class mx{constructor(){this._pool=[],this._index=0}getTriangle(){return this._index>=this._pool.length&&this._pool.push(new re),this._pool[this._index++]}clear(){this._index=0}reset(){this._pool.length=0,this._index=0}}class gx{constructor(){this.trianglePool=new mx,this.triangles=[],this.normal=new z,this.coplanarTriangleUsed=!1}initialize(t){this.reset();const{triangles:e,trianglePool:n,normal:r}=this;if(Array.isArray(t))for(let s=0,o=t.length;s<o;s++){const a=t[s];if(s===0)a.getNormal(r);else if(Math.abs(1-a.getNormal(Ln).dot(r))>Ma)throw new Error("Triangle Splitter: Cannot initialize with triangles that have different normals.");const l=n.getTriangle();l.copy(a),e.push(l)}else{t.getNormal(r);const s=n.getTriangle();s.copy(t),e.push(s)}}splitByTriangle(t){const{normal:e,triangles:n}=this;if(t.getNormal(Sa).normalize(),Math.abs(1-Math.abs(Sa.dot(e)))<px){this.coplanarTriangleUsed=!0;for(let s=0,o=n.length;s<o;s++){const a=n[s];a.coplanarCount=0}const r=[t.a,t.b,t.c];for(let s=0;s<3;s++){const o=(s+1)%3,a=r[s],l=r[o];Ln.subVectors(l,a).normalize(),mu.crossVectors(Sa,Ln),Vs.setFromNormalAndCoplanarPoint(mu,a),this.splitByPlane(Vs,t)}}else t.getPlane(Vs),this.splitByPlane(Vs,t)}splitByPlane(t,e){const{triangles:n,trianglePool:r}=this;Ea.copy(e),Ea.needsUpdate=!0;for(let s=0,o=n.length;s<o;s++){const a=n[s];if(!Ea.intersectsTriangle(a,Pn,!0))continue;const{a:l,b:c,c:u}=a;let d=0,f=-1,m=!1,v=[],S=[];const p=[l,c,u];for(let h=0;h<3;h++){const M=(h+1)%3;Pn.start.copy(p[h]),Pn.end.copy(p[M]);const y=t.distanceToPoint(Pn.start),E=t.distanceToPoint(Pn.end);if(Math.abs(y)<kr&&Math.abs(E)<kr){m=!0;break}if(y>0?v.push(h):S.push(h),Math.abs(y)<kr)continue;let C=!!t.intersectLine(Pn,Ln);!C&&Math.abs(E)<kr&&(Ln.copy(Pn.end),C=!0),C&&!(Ln.distanceTo(Pn.start)<Ma)&&(Ln.distanceTo(Pn.end)<Ma&&(f=h),d===0?ce.start.copy(Ln):ce.end.copy(Ln),d++)}if(!m&&d===2&&ce.distance()>kr)if(f!==-1){f=(f+1)%3;let h=0;h===f&&(h=(h+1)%3);let M=h+1;M===f&&(M=(M+1)%3);const y=r.getTriangle();y.a.copy(p[M]),y.b.copy(ce.end),y.c.copy(ce.start),ii(y)||n.push(y),a.a.copy(p[h]),a.b.copy(ce.start),a.c.copy(ce.end),ii(a)&&(n.splice(s,1),s--,o--)}else{const h=v.length>=2?S[0]:v[0];if(h===0){let A=ce.start;ce.start=ce.end,ce.end=A}const M=(h+1)%3,y=(h+2)%3,E=r.getTriangle(),C=r.getTriangle();p[M].distanceToSquared(ce.start)<p[y].distanceToSquared(ce.end)?(E.a.copy(p[M]),E.b.copy(ce.start),E.c.copy(ce.end),C.a.copy(p[M]),C.b.copy(p[y]),C.c.copy(ce.start)):(E.a.copy(p[y]),E.b.copy(ce.start),E.c.copy(ce.end),C.a.copy(p[M]),C.b.copy(p[y]),C.c.copy(ce.end)),a.a.copy(p[h]),a.b.copy(ce.end),a.c.copy(ce.start),ii(E)||n.push(E),ii(C)||n.push(C),ii(a)&&(n.splice(s,1),s--,o--)}else d===3&&console.warn("TriangleClipper: Coplanar clip not handled")}}reset(){this.triangles.length=0,this.trianglePool.clear(),this.coplanarTriangleUsed=!1}}function _x(i){return i=~~i,i+4-i%4}class gu{constructor(t,e=500){this.expansionFactor=1.5,this.type=t,this.length=0,this.array=null,this.setSize(e)}setType(t){if(this.length!==0)throw new Error("TypeBackedArray: Cannot change the type while there is used data in the buffer.");const e=this.array.buffer;this.array=new t(e),this.type=t}setSize(t){if(this.array&&t===this.array.length)return;const e=this.type,n=Lh()?SharedArrayBuffer:ArrayBuffer,r=new e(new n(_x(t*e.BYTES_PER_ELEMENT)));this.array&&r.set(this.array,0),this.array=r}expand(){const{array:t,expansionFactor:e}=this;this.setSize(t.length*e)}push(...t){let{array:e,length:n}=this;n+t.length>e.length&&(this.expand(),e=this.array);for(let r=0,s=t.length;r<s;r++)e[n+r]=t[r];this.length+=t.length}clear(){this.length=0}}class vx{constructor(){this.groupAttributes=[{}],this.groupCount=0}getType(t){return this.groupAttributes[0][t].type}getItemSize(t){return this.groupAttributes[0][t].itemSize}getNormalized(t){return this.groupAttributes[0][t].normalized}getCount(t){if(this.groupCount<=t)return 0;const e=this.getGroupAttrArray("position",t);return e.length/e.itemSize}getTotalLength(t){const{groupCount:e,groupAttributes:n}=this;let r=0;for(let s=0;s<e;s++){const o=n[s];r+=o[t].length}return r}getGroupAttrSet(t=0){const{groupAttributes:e}=this;if(e[t])return this.groupCount=Math.max(this.groupCount,t+1),e[t];const n=e[0];for(this.groupCount=Math.max(this.groupCount,t+1);t>=e.length;){const r={};e.push(r);for(const s in n){const o=n[s],a=new gu(o.type);a.itemSize=o.itemSize,a.normalized=o.normalized,r[s]=a}}return e[t]}getGroupAttrArray(t,e=0){const{groupAttributes:n}=this;if(!n[0][t])throw new Error(`TypedAttributeData: Attribute with "${t}" has not been initialized`);return this.getGroupAttrSet(e)[t]}initializeArray(t,e,n,r){const{groupAttributes:s}=this,a=s[0][t];if(a){if(a.type!==e)for(let l=0,c=s.length;l<c;l++){const u=s[l][t];u.setType(e),u.itemSize=n,u.normalized=r}}else for(let l=0,c=s.length;l<c;l++){const u=new gu(e);u.itemSize=n,u.normalized=r,s[l][t]=u}}clear(){this.groupCount=0;const{groupAttributes:t}=this;t.forEach(e=>{for(const n in e)e[n].clear()})}delete(t){this.groupAttributes.forEach(e=>{delete e[t]})}reset(){this.groupAttributes=[],this.groupCount=0}}class _u{constructor(){this.intersectionSet={},this.ids=[]}add(t,e){const{intersectionSet:n,ids:r}=this;n[t]||(n[t]=[],r.push(t)),n[t].push(e)}}const xx=0,Ih=1,yx=2,Mx=3,Sx=4,Dh=5,Uh=6,qe=new yo,vu=new $t,Te=new re,In=new z,xu=new te,yu=new te,Mu=new te,ba=new te,Gs=new te,Ws=new te,Su=new sn,Aa=new z,wa=1e-8,Ex=1e-15,wi=-1,Ti=1,eo=-2,no=2,qr=0,Mi=1,Bl=2,bx=1e-14;let io=null;function Eu(i){io=i}function Nh(i,t){i.getMidpoint(qe.origin),i.getNormal(qe.direction);const e=t.raycastFirst(qe,Ze);return!!(e&&qe.direction.dot(e.face.normal)>0)?wi:Ti}function Ax(i,t){function e(){return Math.random()-.5}i.getNormal(Aa),qe.direction.copy(Aa),i.getMidpoint(qe.origin);const n=3;let r=0,s=1/0;for(let o=0;o<n;o++){qe.direction.x+=e()*wa,qe.direction.y+=e()*wa,qe.direction.z+=e()*wa,qe.direction.multiplyScalar(-1);const a=t.raycastFirst(qe,Ze);if(!!(a&&qe.direction.dot(a.face.normal)>0)&&r++,a!==null&&(s=Math.min(s,a.distance)),s<=Ex)return a.face.normal.dot(Aa)>0?no:eo;if(r/n>.5||(o-r+1)/n>.5)break}return r/n>.5?wi:Ti}function wx(i,t){const e=new _u,n=new _u;return vu.copy(i.matrixWorld).invert().multiply(t.matrixWorld),i.geometry.boundsTree.bvhcast(t.geometry.boundsTree,vu,{intersectsTriangles(r,s,o,a){if(!ii(r)&&!ii(s)){let l=r.intersectsTriangle(s,Su,!0);if(!l){const c=r.plane,u=s.plane,d=c.normal,f=u.normal;d.dot(f)===1&&Math.abs(c.constant-u.constant)<bx&&(l=!0)}if(l){let c=i.geometry.boundsTree.resolveTriangleIndex(o),u=t.geometry.boundsTree.resolveTriangleIndex(a);e.add(c,u),n.add(u,c),io&&(io.addEdge(Su),io.addIntersectingTriangles(o,r,a,s))}}return!1}}),{aIntersections:e,bIntersections:n}}function Tx(i,t,e,n,r,s,o=!1){const a=e.attributes,l=e.index,c=i*3,u=l.getX(c+0),d=l.getX(c+1),f=l.getX(c+2);for(const m in s){const v=a[m],S=s[m];if(!(m in a))throw new Error(`CSG Operations: Attribute ${m} not available on geometry.`);const p=v.itemSize;m==="position"?(Te.a.fromBufferAttribute(v,u).applyMatrix4(n),Te.b.fromBufferAttribute(v,d).applyMatrix4(n),Te.c.fromBufferAttribute(v,f).applyMatrix4(n),Ta(Te.a,Te.b,Te.c,t,3,S,o)):m==="normal"?(Te.a.fromBufferAttribute(v,u).applyNormalMatrix(r),Te.b.fromBufferAttribute(v,d).applyNormalMatrix(r),Te.c.fromBufferAttribute(v,f).applyNormalMatrix(r),o&&(Te.a.multiplyScalar(-1),Te.b.multiplyScalar(-1),Te.c.multiplyScalar(-1)),Ta(Te.a,Te.b,Te.c,t,3,S,o,!0)):(xu.fromBufferAttribute(v,u),yu.fromBufferAttribute(v,d),Mu.fromBufferAttribute(v,f),Ta(xu,yu,Mu,t,p,S,o))}}function Cx(i,t,e,n,r,s,o,a=!1){Ca(i,n,r,s,o,a),Ca(a?e:t,n,r,s,o,a),Ca(a?t:e,n,r,s,o,a)}function Fh(i,t,e=!1){switch(i){case xx:if(t===Ti||t===no&&!e)return Mi;break;case Ih:if(e){if(t===wi)return qr}else if(t===Ti||t===eo)return Mi;break;case yx:if(e){if(t===Ti||t===eo)return Mi}else if(t===wi)return qr;break;case Sx:if(t===wi)return qr;if(t===Ti)return Mi;break;case Mx:if(t===wi||t===no&&!e)return Mi;break;case Dh:if(!e&&(t===Ti||t===eo))return Mi;break;case Uh:if(!e&&(t===wi||t===no))return Mi;break;default:throw new Error(`Unrecognized CSG operation enum "${i}".`)}return Bl}function Ta(i,t,e,n,r,s,o=!1,a=!1){const l=c=>{s.push(c.x),r>1&&s.push(c.y),r>2&&s.push(c.z),r>3&&s.push(c.w)};ba.set(0,0,0,0).addScaledVector(i,n.a.x).addScaledVector(t,n.a.y).addScaledVector(e,n.a.z),Gs.set(0,0,0,0).addScaledVector(i,n.b.x).addScaledVector(t,n.b.y).addScaledVector(e,n.b.z),Ws.set(0,0,0,0).addScaledVector(i,n.c.x).addScaledVector(t,n.c.y).addScaledVector(e,n.c.z),a&&(ba.normalize(),Gs.normalize(),Ws.normalize()),l(ba),o?(l(Ws),l(Gs)):(l(Gs),l(Ws))}function Ca(i,t,e,n,r,s=!1){for(const o in r){const a=t[o],l=r[o];if(!(o in t))throw new Error(`CSG Operations: Attribute ${o} no available on geometry.`);const c=a.itemSize;o==="position"?(In.fromBufferAttribute(a,i).applyMatrix4(e),l.push(In.x,In.y,In.z)):o==="normal"?(In.fromBufferAttribute(a,i).applyNormalMatrix(n),s&&In.multiplyScalar(-1),l.push(In.x,In.y,In.z)):(l.push(a.getX(i)),c>1&&l.push(a.getY(i)),c>2&&l.push(a.getZ(i)),c>3&&l.push(a.getW(i)))}}class Rx{constructor(t){this.triangle=new re().copy(t),this.intersects={}}addTriangle(t,e){this.intersects[t]=new re().copy(e)}getIntersectArray(){const t=[],{intersects:e}=this;for(const n in e)t.push(e[n]);return t}}class bu{constructor(){this.data={}}addTriangleIntersection(t,e,n,r){const{data:s}=this;s[t]||(s[t]=new Rx(e)),s[t].addTriangle(n,r)}getTrianglesAsArray(t=null){const{data:e}=this,n=[];if(t!==null)t in e&&n.push(e[t].triangle);else for(const r in e)n.push(e[r].triangle);return n}getTriangleIndices(){return Object.keys(this.data).map(t=>parseInt(t))}getIntersectionIndices(t){const{data:e}=this;return e[t]?Object.keys(e[t].intersects).map(n=>parseInt(n)):[]}getIntersectionsAsArray(t=null,e=null){const{data:n}=this,r=new Set,s=[],o=a=>{if(n[a])if(e!==null)n[a].intersects[e]&&s.push(n[a].intersects[e]);else{const l=n[a].intersects;for(const c in l)r.has(c)||(r.add(c),s.push(l[c]))}};if(t!==null)o(t);else for(const a in n)o(a);return s}reset(){this.data={}}}class Px{constructor(){this.enabled=!1,this.triangleIntersectsA=new bu,this.triangleIntersectsB=new bu,this.intersectionEdges=[]}addIntersectingTriangles(t,e,n,r){const{triangleIntersectsA:s,triangleIntersectsB:o}=this;s.addTriangleIntersection(t,e,n,r),o.addTriangleIntersection(n,r,t,e)}addEdge(t){this.intersectionEdges.push(t.clone())}reset(){this.triangleIntersectsA.reset(),this.triangleIntersectsB.reset(),this.intersectionEdges=[]}init(){this.enabled&&(this.reset(),Eu(this))}complete(){this.enabled&&Eu(null)}}const oi=new $t,po=new Vt,Si=new re,Xs=new re,Qn=new re,Ys=new re,pn=[],Ri=[];function Lx(i){for(const t of i)return t}function Ix(i,t,e,n,r,s={}){const{useGroups:o=!0}=s,{aIntersections:a,bIntersections:l}=wx(i,t),c=[];let u=null,d;return d=o?0:-1,Au(i,t,a,e,!1,n,r,d),wu(i,t,a,e,!1,r,d),e.findIndex(m=>m!==Uh&&m!==Dh)!==-1&&(d=o?i.geometry.groups.length||1:-1,Au(t,i,l,e,!0,n,r,d),wu(t,i,l,e,!0,r,d)),pn.length=0,Ri.length=0,{groups:c,materials:u}}function Au(i,t,e,n,r,s,o,a=0){const l=i.matrixWorld.determinant()<0;oi.copy(t.matrixWorld).invert().multiply(i.matrixWorld),po.getNormalMatrix(i.matrixWorld).multiplyScalar(l?-1:1);const c=i.geometry.groupIndices,u=i.geometry.index,d=i.geometry.attributes.position,f=t.geometry.boundsTree,m=t.geometry.index,v=t.geometry.attributes.position,S=e.ids,p=e.intersectionSet;for(let h=0,M=S.length;h<M;h++){const y=S[h],E=a===-1?0:c[y]+a,C=3*y,A=u.getX(C+0),b=u.getX(C+1),x=u.getX(C+2);Si.a.fromBufferAttribute(d,A).applyMatrix4(oi),Si.b.fromBufferAttribute(d,b).applyMatrix4(oi),Si.c.fromBufferAttribute(d,x).applyMatrix4(oi),s.reset(),s.initialize(Si);const _=p[y];for(let w=0,P=_.length;w<P;w++){const U=3*_[w],F=m.getX(U+0),k=m.getX(U+1),B=m.getX(U+2);Xs.a.fromBufferAttribute(v,F),Xs.b.fromBufferAttribute(v,k),Xs.c.fromBufferAttribute(v,B),s.splitByTriangle(Xs)}const g=s.triangles;for(let w=0,P=g.length;w<P;w++){const U=g[w],F=s.coplanarTriangleUsed?Ax(U,f):Nh(U,f);pn.length=0,Ri.length=0;for(let k=0,B=n.length;k<B;k++){const V=Fh(n[k],F,r);V!==Bl&&(Ri.push(V),pn.push(o[k].getGroupAttrSet(E)))}if(pn.length!==0){Si.getBarycoord(U.a,Ys.a),Si.getBarycoord(U.b,Ys.b),Si.getBarycoord(U.c,Ys.c);for(let k=0,B=pn.length;k<B;k++){const V=pn[k],et=Ri[k]===qr;Tx(y,Ys,i.geometry,i.matrixWorld,po,V,l!==et)}}}}return S.length}function wu(i,t,e,n,r,s,o=0){const a=i.matrixWorld.determinant()<0;oi.copy(t.matrixWorld).invert().multiply(i.matrixWorld),po.getNormalMatrix(i.matrixWorld).multiplyScalar(a?-1:1);const l=t.geometry.boundsTree,c=i.geometry.groupIndices,u=i.geometry.index,d=i.geometry.attributes,f=d.position,m=[],v=i.geometry.halfEdges,S=new Set,p=Ol(i.geometry);for(let h=0,M=p;h<M;h++)h in e.intersectionSet||S.add(h);for(;S.size>0;){const h=Lx(S);S.delete(h),m.push(h);const M=3*h,y=u.getX(M+0),E=u.getX(M+1),C=u.getX(M+2);Qn.a.fromBufferAttribute(f,y).applyMatrix4(oi),Qn.b.fromBufferAttribute(f,E).applyMatrix4(oi),Qn.c.fromBufferAttribute(f,C).applyMatrix4(oi);const A=Nh(Qn,l);Ri.length=0,pn.length=0;for(let b=0,x=n.length;b<x;b++){const _=Fh(n[b],A,r);_!==Bl&&(Ri.push(_),pn.push(s[b]))}for(;m.length>0;){const b=m.pop();for(let x=0;x<3;x++){const _=v.getSiblingTriangleIndex(b,x);_!==-1&&S.has(_)&&(m.push(_),S.delete(_))}if(pn.length!==0){const x=3*b,_=u.getX(x+0),g=u.getX(x+1),w=u.getX(x+2),P=o===-1?0:c[b]+o;if(Qn.a.fromBufferAttribute(f,_),Qn.b.fromBufferAttribute(f,g),Qn.c.fromBufferAttribute(f,w),!ii(Qn))for(let U=0,F=pn.length;U<F;U++){const k=Ri[U],B=pn[U].getGroupAttrSet(P),V=k===qr;Cx(_,g,w,d,i.matrixWorld,po,B,V!==a)}}}}}function Dx(i){for(let t=0;t<i.length-1;t++){const e=i[t],n=i[t+1];if(e.materialIndex===n.materialIndex){const r=e.start,s=n.start+n.count;n.start=r,n.count=s-r,i.splice(t,1),t--}}}function Ux(i,t,e,n){e.clear();const r=i.attributes;for(let s=0,o=n.length;s<o;s++){const a=n[s],l=r[a];e.initializeArray(a,l.array.constructor,l.itemSize,l.normalized)}for(const s in e.attributes)n.includes(s)||e.delete(s);for(const s in t.attributes)n.includes(s)||(t.deleteAttribute(s),t.dispose())}function Nx(i,t,e){let n=!1,r=-1;const s=i.attributes,o=t.groupAttributes[0];for(const l in o){const c=t.getTotalLength(l),u=t.getType(l),d=t.getItemSize(l),f=t.getNormalized(l);let m=s[l];(!m||m.array.length<c)&&(m=new Be(new u(c),d,f),i.setAttribute(l,m),n=!0);let v=0;for(let S=0,p=Math.min(e.length,t.groupCount);S<p;S++){const h=e[S].index,{array:M,type:y,length:E}=t.groupAttributes[h][l],C=new y(M.buffer,0,E);m.array.set(C,v),v+=C.length}m.needsUpdate=!0,r=c/m.itemSize}if(i.index){const l=i.index.array;if(l.length<r)i.index=null,n=!0;else for(let c=0,u=l.length;c<u;c++)l[c]=c}let a=0;i.clearGroups();for(let l=0,c=Math.min(e.length,t.groupCount);l<c;l++){const{index:u,materialIndex:d}=e[l],f=t.getCount(u);f!==0&&(i.addGroup(a,f,d),a+=f)}i.setDrawRange(0,r),i.boundsTree=null,n&&i.dispose()}function Tu(i,t){let e=t;return Array.isArray(t)||(e=[],i.forEach(n=>{e[n.materialIndex]=t})),e}class Fx{constructor(){this.triangleSplitter=new gx,this.attributeData=[],this.attributes=["position","uv","normal"],this.useGroups=!0,this.consolidateGroups=!0,this.debug=new Px}getGroupRanges(t){return!this.useGroups||t.groups.length===0?[{start:0,count:1/0,materialIndex:0}]:t.groups.map(e=>({...e}))}evaluate(t,e,n,r=new fo){let s=!0;if(Array.isArray(n)||(n=[n]),Array.isArray(r)||(r=[r],s=!1),r.length!==n.length)throw new Error("Evaluator: operations and target array passed as different sizes.");t.prepareGeometry(),e.prepareGeometry();const{triangleSplitter:o,attributeData:a,attributes:l,useGroups:c,consolidateGroups:u,debug:d}=this;for(;a.length<r.length;)a.push(new vx);r.forEach((h,M)=>{Ux(t.geometry,h.geometry,a[M],l)}),d.init(),Ix(t,e,n,o,a,{useGroups:c}),d.complete();const f=this.getGroupRanges(t.geometry),m=Tu(f,t.material),v=this.getGroupRanges(e.geometry),S=Tu(v,e.material);v.forEach(h=>h.materialIndex+=m.length);let p=[...f,...v].map((h,M)=>({...h,index:M}));if(c){const h=[...m,...S];u&&(p=p.map(y=>{const E=h[y.materialIndex];return y.materialIndex=h.indexOf(E),y}).sort((y,E)=>y.materialIndex-E.materialIndex));const M=[];for(let y=0,E=h.length;y<E;y++){let C=!1;for(let A=0,b=p.length;A<b;A++){const x=p[A];x.materialIndex===y&&(C=!0,x.materialIndex=M.length)}C&&M.push(h[y])}r.forEach(y=>{y.material=M})}else p=[{start:0,count:1/0,index:0,materialIndex:0}],r.forEach(h=>{h.material=m[0]});return r.forEach((h,M)=>{const y=h.geometry;Nx(y,a[M],p),u&&Dx(y.groups)}),s?r:r[0]}evaluateHierarchy(t,e=new fo){t.updateMatrixWorld(!0);const n=(s,o)=>{const a=s.children;for(let l=0,c=a.length;l<c;l++){const u=a[l];u.isOperationGroup?n(u,o):o(u)}},r=s=>{const o=s.children;let a=!1;for(let c=0,u=o.length;c<u;c++){const d=o[c];a=r(d)||a}const l=s.isDirty();if(l&&s.markUpdated(),a&&!s.isOperationGroup){let c;return n(s,u=>{c?c=this.evaluate(c,u,u.operation):c=this.evaluate(s,u,u.operation)}),s._cachedGeometry=c.geometry,s._cachedMaterials=c.material,!0}else return a||l};return r(t),e.geometry=t._cachedGeometry,e.material=t._cachedMaterials,e}reset(){this.triangleSplitter.reset()}}function bo(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}function $s(i){throw new Error('Could not dynamically require "'+i+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var Oh={exports:{}};(function(i,t){(function(e){i.exports=e()})(function(){return function e(n,r,s){function o(c,u){if(!r[c]){if(!n[c]){var d=typeof $s=="function"&&$s;if(!u&&d)return d(c,!0);if(a)return a(c,!0);throw new Error("Cannot find module '"+c+"'")}u=r[c]={exports:{}},n[c][0].call(u.exports,function(f){var m=n[c][1][f];return o(m||f)},u,u.exports,e,n,r,s)}return r[c].exports}for(var a=typeof $s=="function"&&$s,l=0;l<s.length;l++)o(s[l]);return o}({1:[function(e,n,r){(function(s,o,a,l,c,u,d,f,m){var v=e("crypto");function S(A,b){b=M(A,b);var x;return(x=b.algorithm!=="passthrough"?v.createHash(b.algorithm):new C).write===void 0&&(x.write=x.update,x.end=x.update),E(b,x).dispatch(A),x.update||x.end(""),x.digest?x.digest(b.encoding==="buffer"?void 0:b.encoding):(A=x.read(),b.encoding!=="buffer"?A.toString(b.encoding):A)}(r=n.exports=S).sha1=function(A){return S(A)},r.keys=function(A){return S(A,{excludeValues:!0,algorithm:"sha1",encoding:"hex"})},r.MD5=function(A){return S(A,{algorithm:"md5",encoding:"hex"})},r.keysMD5=function(A){return S(A,{algorithm:"md5",encoding:"hex",excludeValues:!0})};var p=v.getHashes?v.getHashes().slice():["sha1","md5"],h=(p.push("passthrough"),["buffer","hex","binary","base64"]);function M(A,b){var x={};if(x.algorithm=(b=b||{}).algorithm||"sha1",x.encoding=b.encoding||"hex",x.excludeValues=!!b.excludeValues,x.algorithm=x.algorithm.toLowerCase(),x.encoding=x.encoding.toLowerCase(),x.ignoreUnknown=b.ignoreUnknown===!0,x.respectType=b.respectType!==!1,x.respectFunctionNames=b.respectFunctionNames!==!1,x.respectFunctionProperties=b.respectFunctionProperties!==!1,x.unorderedArrays=b.unorderedArrays===!0,x.unorderedSets=b.unorderedSets!==!1,x.unorderedObjects=b.unorderedObjects!==!1,x.replacer=b.replacer||void 0,x.excludeKeys=b.excludeKeys||void 0,A===void 0)throw new Error("Object argument required.");for(var _=0;_<p.length;++_)p[_].toLowerCase()===x.algorithm.toLowerCase()&&(x.algorithm=p[_]);if(p.indexOf(x.algorithm)===-1)throw new Error('Algorithm "'+x.algorithm+'"  not supported. supported values: '+p.join(", "));if(h.indexOf(x.encoding)===-1&&x.algorithm!=="passthrough")throw new Error('Encoding "'+x.encoding+'"  not supported. supported values: '+h.join(", "));return x}function y(A){if(typeof A=="function")return/^function\s+\w*\s*\(\s*\)\s*{\s+\[native code\]\s+}$/i.exec(Function.prototype.toString.call(A))!=null}function E(A,b,x){x=x||[];function _(g){return b.update?b.update(g,"utf8"):b.write(g,"utf8")}return{dispatch:function(g){return this["_"+((g=A.replacer?A.replacer(g):g)===null?"null":typeof g)](g)},_object:function(g){var w,P=Object.prototype.toString.call(g),U=/\[object (.*)\]/i.exec(P);if(U=(U=U?U[1]:"unknown:["+P+"]").toLowerCase(),0<=(P=x.indexOf(g)))return this.dispatch("[CIRCULAR:"+P+"]");if(x.push(g),a!==void 0&&a.isBuffer&&a.isBuffer(g))return _("buffer:"),_(g);if(U==="object"||U==="function"||U==="asyncfunction")return P=Object.keys(g),A.unorderedObjects&&(P=P.sort()),A.respectType===!1||y(g)||P.splice(0,0,"prototype","__proto__","constructor"),A.excludeKeys&&(P=P.filter(function(F){return!A.excludeKeys(F)})),_("object:"+P.length+":"),w=this,P.forEach(function(F){w.dispatch(F),_(":"),A.excludeValues||w.dispatch(g[F]),_(",")});if(!this["_"+U]){if(A.ignoreUnknown)return _("["+U+"]");throw new Error('Unknown object type "'+U+'"')}this["_"+U](g)},_array:function(g,F){F=F!==void 0?F:A.unorderedArrays!==!1;var P=this;if(_("array:"+g.length+":"),!F||g.length<=1)return g.forEach(function(k){return P.dispatch(k)});var U=[],F=g.map(function(k){var B=new C,V=x.slice();return E(A,B,V).dispatch(k),U=U.concat(V.slice(x.length)),B.read().toString()});return x=x.concat(U),F.sort(),this._array(F,!1)},_date:function(g){return _("date:"+g.toJSON())},_symbol:function(g){return _("symbol:"+g.toString())},_error:function(g){return _("error:"+g.toString())},_boolean:function(g){return _("bool:"+g.toString())},_string:function(g){_("string:"+g.length+":"),_(g.toString())},_function:function(g){_("fn:"),y(g)?this.dispatch("[native]"):this.dispatch(g.toString()),A.respectFunctionNames!==!1&&this.dispatch("function-name:"+String(g.name)),A.respectFunctionProperties&&this._object(g)},_number:function(g){return _("number:"+g.toString())},_xml:function(g){return _("xml:"+g.toString())},_null:function(){return _("Null")},_undefined:function(){return _("Undefined")},_regexp:function(g){return _("regex:"+g.toString())},_uint8array:function(g){return _("uint8array:"),this.dispatch(Array.prototype.slice.call(g))},_uint8clampedarray:function(g){return _("uint8clampedarray:"),this.dispatch(Array.prototype.slice.call(g))},_int8array:function(g){return _("int8array:"),this.dispatch(Array.prototype.slice.call(g))},_uint16array:function(g){return _("uint16array:"),this.dispatch(Array.prototype.slice.call(g))},_int16array:function(g){return _("int16array:"),this.dispatch(Array.prototype.slice.call(g))},_uint32array:function(g){return _("uint32array:"),this.dispatch(Array.prototype.slice.call(g))},_int32array:function(g){return _("int32array:"),this.dispatch(Array.prototype.slice.call(g))},_float32array:function(g){return _("float32array:"),this.dispatch(Array.prototype.slice.call(g))},_float64array:function(g){return _("float64array:"),this.dispatch(Array.prototype.slice.call(g))},_arraybuffer:function(g){return _("arraybuffer:"),this.dispatch(new Uint8Array(g))},_url:function(g){return _("url:"+g.toString())},_map:function(g){return _("map:"),g=Array.from(g),this._array(g,A.unorderedSets!==!1)},_set:function(g){return _("set:"),g=Array.from(g),this._array(g,A.unorderedSets!==!1)},_file:function(g){return _("file:"),this.dispatch([g.name,g.size,g.type,g.lastModfied])},_blob:function(){if(A.ignoreUnknown)return _("[blob]");throw Error(`Hashing Blob objects is currently not supported
...
`)&&s!=="\\"?(y(o.join("")),n=hn,t):(o.push(r),s=r,t+1)}function _(){return x()}function g(){return r==="/"&&s==="*"?(o.push(r),y(o.join("")),n=hn,t+1):(o.push(r),s=r,t+1)}function w(){if(s==="."&&/\d/.test(r))return n=Hr,t;if(s==="/"&&r==="*")return n=Ra,t;if(s==="/"&&r==="/")return n=Pa,t;if(r==="."&&o.length){for(;P(o););return n=Hr,t}if(r===";"||r===")"||r==="("){if(o.length)for(;P(o););return y(r),n=hn,t+1}var V=o.length===2&&r!=="=";if(/[\w_\d\s]/.test(r)||V){for(;P(o););return n=hn,t}return o.push(r),s=r,t+1}function P(V){var Y=0,et,nt;do{if(et=Cu.indexOf(V.slice(0,V.length+Y).join("")),nt=Cu[et],et===-1){if(Y--+V.length>0)continue;nt=V.slice(0,1).join("")}return y(nt),u+=nt.length,o=o.slice(nt.length),o.length}while(!0)}function U(){return/[^a-fA-F0-9]/.test(r)?(y(o.join("")),n=hn,t):(o.push(r),s=r,t+1)}function F(){return r==="."||/[eE]/.test(r)?(o.push(r),n=Hr,s=r,t+1):r==="x"&&o.length===1&&o[0]==="0"?(n=Uu,o.push(r),s=r,t+1):/[^\d]/.test(r)?(y(o.join("")),n=hn,t):(o.push(r),s=r,t+1)}function k(){return r==="f"&&(o.push(r),s=r,t+=1),/[eE]/.test(r)||(r==="-"||r==="+")&&/[eE]/.test(s)?(o.push(r),s=r,t+1):/[^\d]/.test(r)?(y(o.join("")),n=hn,t):(o.push(r),s=r,t+1)}function B(){if(/[^\d\w_]/.test(r)){var V=o.join("");return M[V]?n=Kx:h[V]?n=qx:n=jx,y(o.join("")),n=hn,t}return o.push(r),s=r,t+1}}var ty=Gx,ey=ny;function ny(i,t){var e=ty(t),n=[];return n=n.concat(e(i)),n=n.concat(e(null)),n}const iy=bo(ey);var ry=sy;function sy(i){for(var t=[],e=0;e<i.length;e++)i[e].type!=="eof"&&t.push(i[e].data);return t.join("")}const Nu=bo(ry);var oy=ay;function ay(i){var t=null,e=null,n=0,r=0,s=0,o=0,a=0,l=[],c,u,d;for(c=0,u;c<i.length;c++)if(d=i[c],d.data==="{"){if(n&&n++||(u=m(c,ti(")"),ti()),u<0)||(o=u,u=m(u,ti("("),ti(")")),u<0)||(a=u,u=m(u,Vr),u<0)||i[u].type!=="ident"||(e=i[u].data,u=m(u,Vr),u<0))continue;n=1,r=c,t=i[u].data,s=u;var f=m(u,Vr);switch(i[f]&&i[f].data){case"lowp":case"highp":case"mediump":s=f}}else if(n&&d.data==="}"){if(--n)continue;l.push({name:e,type:t,body:[r+1,c],args:[a,o+1],outer:[s,c+1]})}for(c=0;c<i.length;c++)if(d=i[c],d.data===";"){if(u=m(c,ti(")"),ti()),u<0||(o=u,u=m(u,ti("("),ti(")")),u<0)||(a=u,u=m(u,Vr),u<0)||i[u].type!=="ident"||(e=i[u].data,u=m(u,Vr),u<0)||i[u].type==="operator"||i[u].data==="return")continue;t=i[u].data,l.push({name:e,type:t,body:!1,args:[a,o+1],outer:[u,c+1]})}return l.sort(function(v,S){return v.outer[0]-S.outer[0]});function m(v,S,p){for(var h=v-1;h>=0;h--){if(S(i[h]))return h;if(p&&p(i[h]))return-1}return-1}}function ti(i){return function(t){return t.type==="operator"&&(!i||t.data===i)}}function Vr(i){return i.type!=="whitespace"}const ly=bo(oy);function cy(i,t){if(typeof i!="object"||i===null)return i;var e=i[Symbol.toPrimitive];if(e!==void 0){var n=e.call(i,t||"default");if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(i)}function kh(i){var t=cy(i,"string");return typeof t=="symbol"?t:String(t)}function Jt(i,t,e){return t=kh(t),t in i?Object.defineProperty(i,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):i[t]=e,i}function Fu(i,t){var e=Object.keys(i);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(i);t&&(n=n.filter(function(r){return Object.getOwnPropertyDescriptor(i,r).enumerable})),e.push.apply(e,n)}return e}function cr(i){for(var t=1;t<arguments.length;t++){var e=arguments[t]!=null?arguments[t]:{};t%2?Fu(Object(e),!0).forEach(function(n){Jt(i,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(i,Object.getOwnPropertyDescriptors(e)):Fu(Object(e)).forEach(function(n){Object.defineProperty(i,n,Object.getOwnPropertyDescriptor(e,n))})}return i}function uy(i,t){if(i==null)return{};var e={},n=Object.keys(i),r,s;for(s=0;s<n.length;s++)r=n[s],!(t.indexOf(r)>=0)&&(e[r]=i[r]);return e}function hy(i,t){if(i==null)return{};var e=uy(i,t),n,r;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(i);for(r=0;r<s.length;r++)n=s[r],!(t.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(i,n)&&(e[n]=i[n])}return e}function fy(i,t){if(!(i instanceof t))throw new TypeError("Cannot call a class as a function")}function dy(i,t){for(var e=0;e<t.length;e++){var n=t[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(i,kh(n.key),n)}}function py(i,t,e){return dy(i.prototype,t),Object.defineProperty(i,"prototype",{writable:!1}),i}function Hh(i){if(i===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return i}function yl(i,t){return yl=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(n,r){return n.__proto__=r,n},yl(i,t)}function my(i,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function");i.prototype=Object.create(t.prototype,{constructor:{value:i,writable:!0,configurable:!0}}),Object.defineProperty(i,"prototype",{writable:!1}),yl(i,t)}function mo(i){return mo=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(e){return e.__proto__||Object.getPrototypeOf(e)},mo(i)}function gy(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function _y(i,t){if(t&&(typeof t=="object"||typeof t=="function"))return t;if(t!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return Hh(i)}function vy(i){var t=gy();return function(){var n=mo(i),r;if(t){var s=mo(this).constructor;r=Reflect.construct(n,arguments,s)}else r=n.apply(this,arguments);return _y(this,r)}}var Bt={position:"csm_Position",positionRaw:"csm_PositionRaw",pointSize:"csm_PointSize",fragColor:"csm_FragColor",diffuseColor:"csm_DiffuseColor",normal:"csm_Normal",roughness:"csm_Roughness",metalness:"csm_Metalness",emissive:"csm_Emissive",ao:"csm_AO",bump:"csm_Bump",depthAlpha:"csm_DepthAlpha"},Ue,ur,xy=(Ue={},Jt(Ue,"".concat(Bt.normal),{"#include <beginnormal_vertex>":`
  ...
  `)}),Jt(Ue,"".concat(Bt.pointSize),{"gl_PointSize = size;":`
    gl_PointSize = `.concat(Bt.pointSize,`;
    `)}),Jt(Ue,"".concat(Bt.diffuseColor),{"#include <color_fragment>":`
    #include <color_fragment>
    diffuseColor = `.concat(Bt.diffuseColor,`;
  `)}),Jt(Ue,"".concat(Bt.fragColor),{"#include <dithering_fragment>":`
    #include <dithering_fragment>
    gl_FragColor  = `.concat(Bt.fragColor,`;
  `)}),Jt(Ue,"".concat(Bt.emissive),{"vec3 totalEmissiveRadiance = emissive;":`
    vec3 totalEmissiveRadiance = `.concat(Bt.emissive,`;
    `)}),Jt(Ue,"".concat(Bt.roughness),{"#include <roughnessmap_fragment>":`
    #include <roughnessmap_fragment>
    roughnessFactor = `.concat(Bt.roughness,`;
    `)}),Jt(Ue,"".concat(Bt.metalness),{"#include <metalnessmap_fragment>":`
    #include <metalnessmap_fragment>
    metalnessFactor = `.concat(Bt.metalness,`;
    `)}),Jt(Ue,"".concat(Bt.ao),{"#include <aomap_fragment>":`
    #include <aomap_fragment>
    reflectedLight.indirectDiffuse *= 1. - `.concat(Bt.ao,`;
    `)}),Jt(Ue,"".concat(Bt.bump),{"#include <normal_fragment_maps>":`
    #include <normal_fragment_maps>

    vec3 csm_internal_orthogonal = `.concat(Bt.bump," - (dot(").concat(Bt.bump,`, normal) * normal);
    vec3 csm_internal_projectedbump = mat3(csm_internal_vModelViewMatrix) * csm_internal_orthogonal;
    normal = normalize(normal - csm_internal_projectedbump);
    `)}),Jt(Ue,"".concat(Bt.depthAlpha),{"gl_FragColor = vec4( vec3( 1.0 - fragCoordZ ), opacity );":`
      gl_FragColor = vec4( vec3( 1.0 - fragCoordZ ), opacity * `.concat(Bt.depthAlpha,` );
    `),"gl_FragColor = packDepthToRGBA( fragCoordZ );":`
      gl_FragColor = packDepthToRGBA( fragCoordZ );
      gl_FragColor.a *= `.concat(Bt.depthAlpha,`;
    `)}),Ue),yy=(ur={},Jt(ur,"".concat(Bt.position),{"gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );":`
    gl_Position = projectionMatrix * modelViewMatrix * vec4( `.concat(Bt.position,`, 1.0 );
  `)}),Jt(ur,"".concat(Bt.positionRaw),{"gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );":`
    gl_Position = `.concat(Bt.position,`;
  `)}),Jt(ur,"".concat(Bt.diffuseColor),{"gl_FragColor = vec4( 1.0, 0.0, 0.0, 1.0 );":`
    gl_FragColor = `.concat(Bt.diffuseColor,`;
  `)}),Jt(ur,"".concat(Bt.fragColor),{"gl_FragColor = vec4( 1.0, 0.0, 0.0, 1.0 );":`
    gl_FragColor = `.concat(Bt.fragColor,`;
  `)}),ur),My=`
...
`,Ne,wy=(Ne={},Jt(Ne,"".concat(Bt.position),"*"),Jt(Ne,"".concat(Bt.positionRaw),"*"),Jt(Ne,"".concat(Bt.normal),"*"),Jt(Ne,"".concat(Bt.pointSize),["PointsMaterial"]),Jt(Ne,"".concat(Bt.diffuseColor),"*"),Jt(Ne,"".concat(Bt.fragColor),"*"),Jt(Ne,"".concat(Bt.emissive),["MeshStandardMaterial","MeshPhysicalMaterial"]),Jt(Ne,"".concat(Bt.roughness),["MeshStandardMaterial","MeshPhysicalMaterial"]),Jt(Ne,"".concat(Bt.metalness),["MeshStandardMaterial","MeshPhysicalMaterial"]),Jt(Ne,"".concat(Bt.ao),["MeshStandardMaterial","MeshPhysicalMaterial","MeshBasicMaterial","MeshLambertMaterial","MeshPhongMaterial","MeshToonMaterial"]),Jt(Ne,"".concat(Bt.bump),["MeshLambertMaterial","MeshMatcapMaterial","MeshNormalMaterial","MeshPhongMaterial","MeshPhysicalMaterial","MeshStandardMaterial","MeshToonMaterial","ShadowMaterial"]),Jt(Ne,"".concat(Bt.depthAlpha),"*"),Ne),Ty=["baseMaterial","fragmentShader","vertexShader","uniforms","patchMap","cacheKey","silent"],Cy=function(t,e,n){return t.split(e).join(n)},Ry=function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},Py=function(t,e){return new RegExp("\\b".concat(Ry(e),"\\b")).test(t)};function Ly(i){try{new i}catch(t){if(t.message.indexOf("is not a constructor")>=0)return!1}return!0}function Iy(i,t){var e=arguments.length>2&&arguments[2]!==void 0?arguments[2]:!1;Object.assign(i,t);var n=Object.getPrototypeOf(t);Object.entries(Object.getOwnPropertyDescriptors(n)).filter(function(r){var s=typeof r[1].get=="function",o=typeof r[1].set=="function",a=typeof r[1].value=="function",l=r[0]==="constructor";return(s||o||a)&&!l}).forEach(function(r){if(typeof i[r[0]]=="function"){e||console.warn("Function ".concat(r[0]," already exists on CSM, renaming to base_").concat(r[0]));var s="base_".concat(r[0]);i[s]=r[1].value.bind(i);return}Object.defineProperty(i,r[0],r[1])})}function Dy(i){var t=i.toString().trim(),e=t.substring(t.indexOf("{")+1,t.lastIndexOf("}"));return e.trim().length===0}function Ou(i){return i.replace(/\s/g,"")}function Uy(i,t,e){var n=i.lastIndexOf(t);return n===-1?i:i.substring(0,n)+e+i.substring(n+t.length)}var Vh=function(i){my(e,i);var t=vy(e);function e(n){var r,s=n.baseMaterial,o=n.fragmentShader,a=n.vertexShader,l=n.uniforms,c=n.patchMap,u=n.cacheKey,d=n.silent,f=hy(n,Ty);fy(this,e);var m;if(Ly(s)?m=new s(f):(m=s,Object.assign(m,f)),m.type==="RawShaderMaterial")throw new Error("CustomShaderMaterial does not support RawShaderMaterial");r=t.call(this),Iy(Hh(r),m,d),r.__csm={patchMap:c||{},fragmentShader:o||"",vertexShader:a||"",cacheKey:u,baseMaterial:s,instanceID:nh.generateUUID(),type:m.type,isAlreadyExtended:!Dy(m.onBeforeCompile),cacheHash:"",silent:d},r.uniforms=cr(cr({},r.uniforms||{}),l||{});{var v=r.__csm,S=v.fragmentShader,p=v.vertexShader,h=r.uniforms;r.__csm.cacheHash=r.getCacheHash(),r.generateMaterial(S,p,h)}return r}return py(e,[{key:"update",value:function(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};this.uniforms=r.uniforms||this.uniforms,Object.assign(this.__csm,r);var s=this.__csm,o=s.fragmentShader,a=s.vertexShader,l=this.uniforms,c=this.getCacheHash();this.__csm.cacheHash=c,this.generateMaterial(o,a,l)}},{key:"clone",value:function(){var r={baseMaterial:this.__csm.baseMaterial,fragmentShader:this.__csm.fragmentShader,vertexShader:this.__csm.vertexShader,uniforms:this.uniforms,silent:this.__csm.silent,patchMap:this.__csm.patchMap,cacheKey:this.__csm.cacheKey},s=new this.constructor(r);return Object.assign(this,s),s}},{key:"getCacheHash",value:function(){var r=this.__csm,s=r.fragmentShader,o=r.vertexShader,a=this.uniforms,l=Object.values(a).reduce(function(u,d){var f=d.value;return u+JSON.stringify(f)},""),c=Ou(s)+Ou(o)+l;return c.trim().length>0?Bx(c):this.customProgramCacheKey()}},{key:"generateMaterial",value:function(r,s,o){var a=this,l=this.parseShader(r),c=this.parseShader(s);this.uniforms=o||{},this.customProgramCacheKey=function(){return a.__csm.cacheHash};var u=function(m){try{if(l){var v=a.patchShader(l,m.fragmentShader,!0);m.fragmentShader=a.getMaterialDefine()+v}if(c){var S=a.patchShader(c,m.vertexShader);m.vertexShader=`#define IS_VERTEX;
`+S,m.vertexShader=a.getMaterialDefine()+m.vertexShader}m.uniforms=cr(cr({},m.uniforms),a.uniforms),a.uniforms=m.uniforms}catch(p){console.error(p)}};if(this.__csm.isAlreadyExtended){var d=this.onBeforeCompile;this.onBeforeCompile=function(f,m){d(f,m),u(f)}}else this.onBeforeCompile=u;this.needsUpdate=!0}},{key:"patchShader",value:function(r,s,o){var a=this,l=s,c=cr(cr({},this.getPatchMapForMaterial()),this.__csm.patchMap);Object.keys(c).forEach(function(f){Object.keys(c[f]).forEach(function(m){var v=wy[f],S=a.__csm.type;if(f==="*"||Py(r.main,f))if(!v||Array.isArray(v)&&v.includes(S)||v==="*")l=Cy(l,m,c[f][m]);else throw new Error("CSM: ".concat(f," is not available in ").concat(S,". Shader cannot compile."))})}),l=l.replace("void main() {",`
        ...
        void main() {
          ...
          // CSM_START
      `));var u=this.__csm.isAlreadyExtended,d=l.includes("// CSM_END");return u&&d?l=Uy(l,"// CSM_END",`
          // CSM_END
          `.concat(r.main,`
          // CSM_END
        ...
        `.concat(r.main,`
        // CSM_END
          `)),l=r.defines+l,l}},{key:"parseShader",value:function(r){if(r){var s=r.replace(/\/\*\*(.*?)\*\/|\/\/(.*?)\n/gm,""),o=iy(s),a=ly(o),l=a.map(function(d){return d.name}).indexOf("main"),c=Nu(o.slice(0,l>=0?a[l].outer[0]:void 0)),u=l>=0?this.getShaderFromIndex(o,a[l].body):"";return{defines:"",header:c,main:u}}}},{key:"getMaterialDefine",value:function(){var r=this.__csm.type;return r?"#define IS_".concat(r.toUpperCase(),`;
`):`#define IS_UNKNOWN;
`}},{key:"getPatchMapForMaterial",value:function(){switch(this.__csm.type){case"ShaderMaterial":return yy;default:return xy}}},{key:"getShaderFromIndex",value:function(r,s){return Nu(r.slice(s[0],s[1]))}}]),e}(br),Ny=`uniform vec3 uColorWaterDeep;
...
}`;const we=new Dl({width:325}),Zt={},Wh=document.querySelector("canvas.webgl"),zn=new _0,Fy=new I0;Fy.load("/spruit_sunrise.hdr",i=>{i.mapping=so,zn.background=i,zn.backgroundBlurriness=.5,zn.environment=i});const Ao=new Ar(10,10,1500,1500);Ao.deleteAttribute("uv");Ao.deleteAttribute("normal");Ao.rotateX(-Math.PI*.5);Zt.colorWaterDeep="#002b3d";Zt.colorWaterSurface="#66a8ff";Zt.colorSand="#ffe894";Zt.colorGrass="#85d534";Zt.colorSnow="#ffffff";Zt.colorRock="#bfbd8d";const Ye={uTime:new Ge(0),uPositionFrecuency:new Ge(.2),uStrength:new Ge(2),uWarpFrecuency:new Ge(5),uWarpStrength:new Ge(.5),uColorWaterDeep:new Ge(new Wt(Zt.colorWaterDeep)),uColorWaterSurface:new Ge(new Wt(Zt.colorWaterSurface)),uColorSand:new Ge(new Wt(Zt.colorSand)),uColorGrass:new Ge(new Wt(Zt.colorGrass)),uColorSnow:new Ge(new Wt(Zt.colorSnow)),uColorRock:new Ge(new Wt(Zt.colorRock))};we.add(Ye.uPositionFrecuency,"value",0,1,.001).name("uPositionFrecuency");we.add(Ye.uStrength,"value",0,10,.001).name("uStrength");we.add(Ye.uWarpFrecuency,"value",0,10,.001).name("uWarpFrecuency");we.add(Ye.uWarpStrength,"value",0,1,.001).name("uWarpStrength");we.addColor(Zt,"colorWaterDeep");we.addColor(Zt,"colorWaterSurface");we.addColor(Zt,"colorSand");we.addColor(Zt,"colorGrass");we.addColor(Zt,"colorSnow");we.addColor(Zt,"colorRock");we.addColor(Zt,"colorWaterDeep").onChange(()=>Ye.uColorWaterDeep.value.set(Zt.colorWaterDeep));we.addColor(Zt,"colorWaterSurface").onChange(()=>Ye.uColorWaterSurface.value.set(Zt.colorWaterSurface));we.addColor(Zt,"colorSand").onChange(()=>Ye.uColorSand.value.set(Zt.colorSand));we.addColor(Zt,"colorGrass").onChange(()=>Ye.uColorGrass.value.set(Zt.colorGrass));we.addColor(Zt,"colorSnow").onChange(()=>Ye.uColorSnow.value.set(Zt.colorSnow));we.addColor(Zt,"colorRock").onChange(()=>Ye.uColorRock.value.set(Zt.colorRock));const Oy=new Vh({baseMaterial:Ll,vertexShader:Gh,fragmentShader:Ny,silent:!0,uniforms:Ye,metalness:0,roughness:.5,color:"#85d534"}),By=new Vh({baseMaterial:Sh,vertexShader:Gh,silent:!0,uniforms:Ye,depthFunc:Qu}),wo=new Qe(Ao,Oy);wo.depthMaterial=By;wo.castShadow=!0;wo.receiveShadow=!0;zn.add(wo);const zl=new Qe(new Ar(10,10,1,1),new x0({transmission:1,roughness:.3}));zl.rotation.x=-Math.PI*.5;zl.position.y=-.1;zn.add(zl);const zy=new fo(new Ni(11,2,11)),ky=new fo(new Ni(10,2.1,10)),Hy=new Fx,Qr=Hy.evaluate(zy,ky,Ih);Qr.geometry.clearGroups();Qr.material=new Ll({color:"#ffffff",metalness:0,roughness:.3});Qr.castShadow=!0;Qr.receiveShadow=!0;zn.add(Qr);const Sn=new C0("#ffffff",2);Sn.position.set(6.25,3,4);Sn.castShadow=!0;Sn.shadow.mapSize.set(1024,1024);Sn.shadow.camera.near=.1;Sn.shadow.camera.far=30;Sn.shadow.camera.top=8;Sn.shadow.camera.right=8;Sn.shadow.camera.bottom=-8;Sn.shadow.camera.left=-8;zn.add(Sn);const We={width:window.innerWidth,height:window.innerHeight,pixelRatio:Math.min(window.devicePixelRatio,2)};window.addEventListener("resize",()=>{We.width=window.innerWidth,We.height=window.innerHeight,We.pixelRatio=Math.min(window.devicePixelRatio,2),Sr.aspect=We.width/We.height,Sr.updateProjectionMatrix(),Vn.setSize(We.width,We.height),Vn.setPixelRatio(We.pixelRatio)});const Sr=new Ke(35,We.width/We.height,.1,100);Sr.position.set(-10,6,-2);zn.add(Sr);const Xh=new L0(Sr,Wh);Xh.enableDamping=!0;const Vn=new g0({canvas:Wh,antialias:!0});Vn.shadowMap.enabled=!0;Vn.shadowMap.type=zu;Vn.toneMapping=Hu;Vn.toneMappingExposure=1;Vn.setSize(We.width,We.height);Vn.setPixelRatio(We.pixelRatio);const Vy=new R0,Yh=()=>{const i=Vy.getElapsedTime();Ye.uTime.value=i,Xh.update(),Vn.render(zn,Sr),window.requestAnimationFrame(Yh)};Yh();
//# sourceMappingURL=index-DoJEi9iW.js.map
